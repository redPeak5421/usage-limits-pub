...
public enum AppLanguage: String, CaseIterable, Codable, Sendable, Identifiable {
    ...
    /// 具体语言（去掉 system），字符串表与遍历都以此为准。
    public static let concrete: [AppLanguage] = allCases.filter { $0 != .system }
    ...
    public var resolved: AppLanguage {
        ...
        return AppLanguage.match(Locale.preferredLanguages.first) ?? .en
    }

    /// 把系统语言标签映射到支持的语言。中文按脚本子标签分繁简；
    /// 只带地区码的旧写法（zh-TW / zh-HK / zh-MO）按繁体处理，其余中文回落简体。
    static func match(_ tag: String?) -> AppLanguage? {
        guard let tag = tag?.lowercased(), !tag.isEmpty else { return nil }
        if tag == "zh" || tag.hasPrefix("zh-") || tag.hasPrefix("zh_") {
            if tag.contains("hant") { return .zhHant }
            if tag.contains("hans") { return .zh }
            for region in ["tw", "hk", "mo"] where tag.hasSuffix("-" + region) || tag.hasSuffix("_" + region) {
                return .zhHant
            }
            return .zh
        }
        for lang in [AppLanguage.en, .ja, .fr, .ru] where tag.hasPrefix(lang.rawValue) {
            return lang
        }
        return nil
    }
...
public enum L10n {
    ...
    /// key → 语言 → 文案。新增字符串时 `AppLanguage.concrete` 的六种语言都要补齐，
    ...
    static let table: [String: [AppLanguage: String]] = [
        ...
        "openai.reset.count": [.zh: "%ld 次", .zhHant: "%ld 次", .en: "%ld", .ja: "%ld 回", .fr: "%ld", .ru: "%ld"],
        "openai.reset.atLeast": [.zh: "至少 %ld 次", .zhHant: "至少 %ld 次", .en: "At least %ld", .ja: "%ld 回以上", .fr: "Au moins %ld", .ru: "Не менее %ld"],
        // grok.com「Usage Limit Reset」：一次性重置券，用一张清零一次本周期用量。
        "grok.reset.available": [.zh: "可用重置", .zhHant: "可用重置", .en: "Available resets", .ja: "利用可能", .fr: "Disponibles", .ru: "Доступно"],
        "grok.reset.expiryDate": [.zh: "到期", .zhHant: "到期", .en: "Expires", .ja: "有効期限", .fr: "Expiration", .ru: "Истекает"],
        "grok.reset.count": [.zh: "%ld 次", .zhHant: "%ld 次", .en: "%ld", .ja: "%ld 回", .fr: "%ld", .ru: "%ld"],
        ...
        "%@ 小时窗口": [
            .zh: "%@ 小时窗口", .zhHant: "%@ 小時時段", .en: "%@-hour window", .ja: "%@時間ウィンドウ",
            .fr: "Fenêtre %@ h", .ru: "Окно %@ ч",
        ],
        "%d 天窗口": [
            .zh: "%d 天窗口", .zhHant: "%d 天時段", .en: "%d-day window", .ja: "%d日ウィンドウ",
            .fr: "Fenêtre %d j", .ru: "Окно %d дн.",
        ],
        "5 小时窗口": [
            .zh: "5 小时窗口", .zhHant: "5 小時時段", .en: "5-hour window", .ja: "5時間ウィンドウ",
            .fr: "Fenêtre 5 h", .ru: "Окно 5 часов",
        ],
        "5h 限额": [
            .zh: "5h 限额", .zhHant: "5h 限額", .en: "5h limit", .ja: "5時間上限",
            .fr: "Limite 5 h", .ru: "Лимит 5 ч",
        ],
        "Abacus 响应格式异常": [
            .zh: "Abacus 响应格式异常", .zhHant: "Abacus 回應格式異常", .en: "Abacus response is malformed", .ja: "Abacus応答の形式が不正です",
            .fr: "Réponse Abacus mal formée", .ru: "Некорректный ответ Abacus",
        ],
        "Abacus 接口返回失败": [
            .zh: "Abacus 接口返回失败", .zhHant: "Abacus API 回傳失敗", .en: "Abacus request failed", .ja: "Abacusリクエスト失敗",
            .fr: "Échec de la requête Abacus", .ru: "Ошибка запроса Abacus",
        ],
        "Base - max": [
            .zh: "Base - max", .zhHant: "Base - max", .en: "Base - max", .ja: "Base - max",
            .fr: "Base - max", .ru: "Base - max",
        ],
        "Base（4 小时）": [
            .zh: "Base（4 小时）", .zhHant: "Base（4 小時）", .en: "Base (4 hours)", .ja: "Base（4時間）",
            .fr: "Base (4 h)", .ru: "Base (4 часа)",
        ],
        "Billing Period": [
            .zh: "账期", .zhHant: "帳單週期", .en: "Billing Period", .ja: "請求期間",
            .fr: "Période de facturation", .ru: "Расчётный период",
        ],
        "Code 7 天": [
            .zh: "Code 7 天", .zhHant: "Code 7 天", .en: "Code 7-day", .ja: "Code 7日",
            .fr: "Code 7 j", .ru: "Code 7 дней",
        ],
        "Codex credits": [
            .zh: "Codex 积分", .zhHant: "Codex 點數", .en: "Codex credits", .ja: "Codexクレジット",
            .fr: "Crédits Codex", .ru: "Кредиты Codex",
        ],
        "Codex 代码审查": [
            .zh: "Codex 代码审查", .zhHant: "Codex 程式碼審查", .en: "Codex code review", .ja: "Codex コードレビュー",
            .fr: "Revue de code Codex", .ru: "Ревью кода Codex",
        ],
        "Compute Points": [
            .zh: "计算点数", .zhHant: "運算點數", .en: "Compute Points", .ja: "コンピュートポイント",
            .fr: "Points de calcul", .ru: "Баллы вычислений",
        ],
        "Credits": [
            .zh: "积分", .zhHant: "點數", .en: "Credits", .ja: "クレジット",
            .fr: "Crédits", .ru: "Кредиты",
        ],
        "Cursor Models": [
            .zh: "Cursor 模型", .zhHant: "Cursor 模型", .en: "Cursor Models", .ja: "Cursorモデル",
            .fr: "Modèles Cursor", .ru: "Модели Cursor",
        ],
        "DeepSeek code": [
            .zh: "DeepSeek 错误码", .zhHant: "DeepSeek 錯誤碼", .en: "DeepSeek code", .ja: "DeepSeek code",
            .fr: "DeepSeek code", .ru: "DeepSeek code",
        ],
        "Extra usage": [
            .zh: "额外用量", .zhHant: "額外用量", .en: "Extra usage", .ja: "追加使用量",
            .fr: "Usage supplémentaire", .ru: "Дополнительный расход",
        ],
        "Grok Bot": [
            .zh: "Grok 机器人", .zhHant: "Grok 機器人", .en: "Grok Bot", .ja: "Grokボット",
            .fr: "Grok Bot", .ru: "Grok Bot",
        ],
        "HTTP \\(status)": [
            .zh: "HTTP \\(status)", .zhHant: "HTTP \\(status)", .en: "HTTP \\(status)", .ja: "HTTP \\(status)",
            .fr: "HTTP \\(status)", .ru: "HTTP \\(status)",
        ],
        "Hourly usage": [
            .zh: "每小时用量", .zhHant: "每小時用量", .en: "Hourly usage", .ja: "時間あたりの使用量",
            .fr: "Usage horaire", .ru: "Почасовой расход",
        ],
        "Included": [
            .zh: "包含额度", .zhHant: "包含額度", .en: "Included", .ja: "含まれる枠",
            .fr: "Inclus", .ru: "Включено",
        ],
        "LongCat code": [
            .zh: "LongCat 错误码", .zhHant: "LongCat 錯誤碼", .en: "LongCat code", .ja: "LongCat code",
            .fr: "LongCat code", .ru: "LongCat code",
        ],
        "LongCat 响应数据异常": [
            .zh: "LongCat 响应数据异常", .zhHant: "LongCat 回應資料異常", .en: "LongCat response is invalid", .ja: "LongCat応答が不正です",
            .fr: "Réponse LongCat invalide", .ru: "Некорректный ответ LongCat",
        ],
        "MCP 每月额度": [
            .zh: "MCP 每月额度", .zhHant: "MCP 每月額度", .en: "MCP monthly quota", .ja: "MCP 月間枠",
            .fr: "Quota MCP mensuel", .ru: "Месячная квота MCP",
        ],
        "Monthly spend limit": [
            .zh: "月度消费上限", .zhHant: "每月消費上限", .en: "Monthly spend limit", .ja: "月間支出上限",
            .fr: "Plafond de dépenses mensuel", .ru: "Месячный лимит трат",
        ],
        "Notion AI 额度数据异常": [
            .zh: "Notion AI 额度数据异常", .zhHant: "Notion AI 額度資料異常", .en: "Notion AI quota data is invalid", .ja: "Notion AI枠データが不正です",
            .fr: "Données de quota Notion AI invalides", .ru: "Некорректная квота Notion AI",
        ],
        "Notion workspace 摘要异常": [
            .zh: "Notion workspace 摘要异常", .zhHant: "Notion workspace 摘要異常", .en: "Notion workspace summary is invalid", .ja: "Notionワークスペース要約が不正です",
            .fr: "Résumé d'espace Notion invalide", .ru: "Некорректная сводка workspace Notion",
        ],
        "Ollama 用量数据异常": [
            .zh: "Ollama 用量数据异常", .zhHant: "Ollama 用量資料異常", .en: "Ollama usage data is invalid", .ja: "Ollama使用量データが不正です",
            .fr: "Données d'usage Ollama invalides", .ru: "Некорректные данные Ollama",
        ],
        "On-demand": [
            .zh: "按需", .zhHant: "隨選", .en: "On-demand", .ja: "オンデマンド",
            .fr: "À la demande", .ru: "По запросу",
        ],
        "Other Models": [
            .zh: "其他模型", .zhHant: "其他模型", .en: "Other Models", .ja: "その他のモデル",
            .fr: "Autres modèles", .ru: "Другие модели",
        ],
        "Overage": [
            .zh: "超额", .zhHant: "超額", .en: "Overage", .ja: "超過分",
            .fr: "Dépassement", .ru: "Сверх лимита",
        ],
        "Requests": [
            .zh: "请求", .zhHant: "請求", .en: "Requests", .ja: "リクエスト",
            .fr: "Requêtes", .ru: "Запросы",
        ],
        "Rolling": [
            .zh: "Rolling", .zhHant: "Rolling", .en: "Rolling", .ja: "ローリング",
            .fr: "Glissant", .ru: "Скользящий",
        ],
        "Rolling（%d 分钟）": [
            .zh: "Rolling（%d 分钟）", .zhHant: "Rolling（%d 分鐘）", .en: "Rolling (%d minutes)", .ja: "ローリング（%d分）",
            .fr: "Glissant (%d min)", .ru: "Скользящее (%d мин)",
        ],
        "Rolling（%d 周）": [
            .zh: "Rolling（%d 周）", .zhHant: "Rolling（%d 週）", .en: "Rolling (%d weeks)", .ja: "ローリング（%d週）",
            .fr: "Glissant (%d sem.)", .ru: "Скользящее (%d нед.)",
        ],
        "Rolling（%d 天）": [
            .zh: "Rolling（%d 天）", .zhHant: "Rolling（%d 天）", .en: "Rolling (%d days)", .ja: "ローリング（%d日）",
            .fr: "Glissant (%d j)", .ru: "Скользящее (%d дн.)",
        ],
        "Rolling（%d 小时）": [
            .zh: "Rolling（%d 小时）", .zhHant: "Rolling（%d 小時）", .en: "Rolling (%d hours)", .ja: "ローリング（%d時間）",
            .fr: "Glissant (%d h)", .ru: "Скользящее (%d ч)",
        ],
        "Session usage": [
            .zh: "会话用量", .zhHant: "工作階段用量", .en: "Session usage", .ja: "セッション使用量",
            .fr: "Usage de session", .ru: "Расход сессии",
        ],
        "StepFun API 返回失败": [
            .zh: "StepFun API 返回失败", .zhHant: "StepFun API 回傳失敗", .en: "StepFun API request failed", .ja: "StepFun APIリクエスト失敗",
            .fr: "Échec de l'API StepFun", .ru: "Ошибка API StepFun",
        ],
        "StepFun 用量数据异常": [
            .zh: "StepFun 用量数据异常", .zhHant: "StepFun 用量資料異常", .en: "StepFun usage data is invalid", .ja: "StepFun使用量データが不正です",
            .fr: "Données d'usage StepFun invalides", .ru: "Некорректные данные StepFun",
        ],
        "T3 Chat 主窗口数据异常": [
            .zh: "T3 Chat 主窗口数据异常", .zhHant: "T3 Chat 主時段資料異常", .en: "T3 Chat primary window data is invalid", .ja: "T3 Chat主ウィンドウデータが不正です",
            .fr: "Données de fenêtre principale T3 Chat invalides", .ru: "Некорректные данные основного окна T3 Chat",
        ],
        "T3 Chat 遇到 Vercel 风控挑战": [
            .zh: "T3 Chat 遇到 Vercel 风控挑战", .zhHant: "T3 Chat 遇到 Vercel 風控挑戰", .en: "T3 Chat hit a Vercel challenge", .ja: "T3 ChatがVercelチャレンジに当たりました",
            .fr: "T3 Chat a rencontré un défi Vercel", .ru: "T3 Chat столкнулся с проверкой Vercel",
        ],
        "Team on-demand": [
            .zh: "团队按需", .zhHant: "團隊隨選", .en: "Team on-demand", .ja: "チームオンデマンド",
            .fr: "Équipe à la demande", .ru: "Команда по запросу",
        ],
        "Team pooled": [
            .zh: "团队共享", .zhHant: "團隊共用", .en: "Team pooled", .ja: "チーム共有",
            .fr: "Mutualisé équipe", .ru: "Командный пул",
        ],
        "Token 包": [
            .zh: "Token 包", .zhHant: "Token 包", .en: "Token pack", .ja: "トークンパック",
            .fr: "Pack de tokens", .ru: "Пакет токенов",
        ],
        "Token 额度": [
            .zh: "Token 额度", .zhHant: "Token 額度", .en: "Token quota", .ja: "トークン枠",
            .fr: "Quota de tokens", .ru: "Квота токенов",
        ],
        "Total": [
            .zh: "总计", .zhHant: "總計", .en: "Total", .ja: "合計",
            .fr: "Total", .ru: "Итого",
        ],
        "Usage credits": [
            .zh: "用量积分", .zhHant: "用量點數", .en: "Usage credits", .ja: "使用クレジット",
            .fr: "Crédits d'usage", .ru: "Кредиты использования",
        ],
        "Weekly usage": [
            .zh: "每周用量", .zhHant: "每週用量", .en: "Weekly usage", .ja: "週間使用量",
            .fr: "Usage hebdomadaire", .ru: "Недельный расход",
        ],
        "Zen 余额": [
            .zh: "Zen 余额", .zhHant: "Zen 餘額", .en: "Zen balance", .ja: "Zen 残高",
            .fr: "Solde Zen", .ru: "Баланс Zen",
        ],
        "Zen 月上限": [
            .zh: "Zen 月上限", .zhHant: "Zen 月上限", .en: "Zen monthly cap", .ja: "Zen 月上限",
            .fr: "Plafond mensuel Zen", .ru: "Месячный лимит Zen",
        ],
        "account.delete": [
            .zh: "删除", .zhHant: "刪除", .en: "Delete", .ja: "削除",
            .fr: "Supprimer", .ru: "Удалить",
        ],
        "account.disable": [
            .zh: "停用", .zhHant: "停用", .en: "Disable", .ja: "停止",
            .fr: "Désactiver", .ru: "Отключить",
        ],
        "account.disabled": [
            .zh: "已停用", .zhHant: "已停用", .en: "Disabled", .ja: "停止中",
            .fr: "Désactivé", .ru: "Отключено",
        ],
        "account.enable": [
            .zh: "启用", .zhHant: "啟用", .en: "Enable", .ja: "有効化",
            .fr: "Activer", .ru: "Включить",
        ],
        "account.loggedIn": [
            .zh: "已登录", .zhHant: "已登入", .en: "Signed in", .ja: "ログイン済み",
            .fr: "Connecté", .ru: "Выполнен вход",
        ],
        "account.login": [
            .zh: "登录", .zhHant: "登入", .en: "Log in", .ja: "ログイン",
            .fr: "Connexion", .ru: "Войти",
        ],
        "account.rename": [
            .zh: "重命名", .zhHant: "重新命名", .en: "Rename", .ja: "名前を変更",
            .fr: "Renommer", .ru: "Переименовать",
        ],
        "app.title": [
            .zh: "Usage Limits", .zhHant: "Usage Limits", .en: "Usage Limits", .ja: "Usage Limits",
            .fr: "Usage Limits", .ru: "Usage Limits",
        ],
        "card.allUnused": [
            .zh: "本套餐额度均未使用", .zhHant: "本方案額度均未使用", .en: "No plan usage yet", .ja: "このプランの使用量はまだありません",
            .fr: "Aucune utilisation pour l'instant", .ru: "Лимиты тарифа ещё не использованы",
        ],
        "card.expandMore": [
            .zh: "展开查看其余 %d 项用量", .zhHant: "展開查看其餘 %d 項用量", .en: "Expand to see %d more metrics", .ja: "展開して残り %d 件を表示",
            .fr: "Développer pour voir %d autres mesures", .ru: "Развернуть ещё %d показателей",
        ],
        "card.hideUnused": [
            .zh: "隐藏未使用的指标", .zhHant: "隱藏未使用的指標", .en: "Hide unused metrics", .ja: "未使用の項目を隠す",
            .fr: "Masquer les mesures inutilisées", .ru: "Скрыть неиспользуемые показатели",
        ],
        "card.login": [
            .zh: "登录 %@", .zhHant: "登入 %@", .en: "Sign in to %@", .ja: "%@ にログイン",
            .fr: "Se connecter à %@", .ru: "Войти в %@",
        ],
        "card.loginToSee": [
            .zh: "登录 %@ 查看订阅额度", .zhHant: "登入 %@ 查看訂閱額度", .en: "Sign in to %@ for plan limits", .ja: "%@ にログインしてプラン上限を表示",
            .fr: "Connectez-vous à %@ pour les limites", .ru: "Войдите в %@ для лимитов тарифа",
        ],
        "card.logout": [
            .zh: "退出登录（清除本机 Cookie）", .zhHant: "登出（清除本機 Cookie）", .en: "Sign out (clear local cookies)", .ja: "ログアウト（ローカル Cookie を削除）",
            .fr: "Se déconnecter (effacer les cookies locaux)", .ru: "Выйти (удалить локальные cookie)",
        ],
        "card.noNumeric": [
            .zh: "已登录，但官方未提供数值额度", .zhHant: "已登入，但官方未提供數值額度", .en: "Signed in, but no numeric limits provided", .ja: "ログイン済みですが、数値の上限は提供されていません",
            .fr: "Connecté, mais aucune limite chiffrée fournie", .ru: "Вход выполнен, но числовые лимиты не предоставлены",
        ],
        "card.notLoggedIn": [
            .zh: "未登录", .zhHant: "未登入", .en: "Not signed in", .ja: "未ログイン",
            .fr: "Non connecté", .ru: "Вход не выполнен",
        ],
        "card.refresh": [
            .zh: "刷新用量", .zhHant: "重新整理用量", .en: "Refresh usage", .ja: "使用状況を更新",
            .fr: "Actualiser", .ru: "Обновить",
        ],
        "card.relogin": [
            .zh: "重新登录", .zhHant: "重新登入", .en: "Sign in again", .ja: "再ログイン",
            .fr: "Se reconnecter", .ru: "Войти заново",
        ],
        "card.reorderMetrics": [
            .zh: "调整额度顺序", .zhHant: "調整額度順序", .en: "Reorder quotas", .ja: "利用枠の並び替え",
            .fr: "Réorganiser les quotas", .ru: "Порядок квот",
        ],
        "card.retry": [
            .zh: "重试", .zhHant: "重試", .en: "Retry", .ja: "再試行",
            .fr: "Réessayer", .ru: "Повторить",
        ],
        "card.share": [
            .zh: "分享用量", .zhHant: "分享用量", .en: "Share usage", .ja: "使用状況を共有",
            .fr: "Partager l'usage", .ru: "Поделиться",
        ],
        "card.showUnused": [
            .zh: "显示 %d 项未使用的指标", .zhHant: "顯示 %d 項未使用的指標", .en: "Show %d unused metrics", .ja: "未使用の %d 件を表示",
            .fr: "Afficher %d mesures inutilisées", .ru: "Показать неиспользуемые (%d)",
        ],
        "card.updateToken": [
            .zh: "更新令牌", .zhHant: "更新權杖", .en: "Update token", .ja: "トークンを更新",
            .fr: "Mettre à jour le jeton", .ru: "Обновить токен",
        ],
        "card.updatedAt": [
            .zh: "更新于 %@", .zhHant: "更新於 %@", .en: "Updated at %@", .ja: "%@ 更新",
            .fr: "Mis à jour à %@", .ru: "Обновлено в %@",
        ],
        "common.ok": [
            .zh: "确定", .zhHant: "確定", .en: "OK", .ja: "OK",
            .fr: "OK", .ru: "OK",
        ],
        ...
        "custom.card.moreFields": [
            .zh: "还有 %d 项，展开查看", .zhHant: "還有 %d 項，展開查看", .en: "%d more, expand to view", .ja: "他 %d 件、展開して表示",
            .fr: "%d de plus, développer", .ru: "Ещё %d, развернуть",
        ],
        "custom.card.usedShare": [
            .zh: "已用占比 %d%%", .zhHant: "已用佔比 %d%%", .en: "Used share %d%%", .ja: "使用割合 %d%%",
            .fr: "Part utilisée %d%%", .ru: "Доля использованного %d%%",
        ],
        "custom.error.notJSON": [
            .zh: "不是 JSON", .zhHant: "不是 JSON", .en: "Not JSON", .ja: "JSON ではありません",
            .fr: "Pas du JSON", .ru: "Не JSON",
        ],
        "custom.error.requestFailed": [
            .zh: "请求失败", .zhHant: "請求失敗", .en: "Request failed", .ja: "リクエスト失敗",
            .fr: "Échec de la requête", .ru: "Ошибка запроса",
        ],
        "custom.error.tooLarge": [
            .zh: "响应过大", .zhHant: "回應過大", .en: "Response too large", .ja: "応答が大きすぎます",
            .fr: "Réponse trop grande", .ru: "Слишком большой ответ",
        ],
        "custom.error.unreadable": [
            .zh: "字段无法读取", .zhHant: "欄位無法讀取", .en: "Couldn't read fields", .ja: "フィールドを読めません",
            .fr: "Champs illisibles", .ru: "Не удалось прочитать поля",
        ],
        "custom.logout": [
            .zh: "清除令牌", .zhHant: "清除權杖", .en: "Clear token", .ja: "トークンを削除",
            .fr: "Effacer le jeton", .ru: "Удалить токен",
        ],
        "custom.noNumeric": [
            .zh: "已登录，但没有可显示的数字", .zhHant: "已登入，但沒有可顯示的數字", .en: "Signed in, but no numbers to show", .ja: "ログイン済みですが数字がありません",
        ...
        "custom.preset.kimi-api-intl.name": [
            .zh: "Kimi API", .zhHant: "Kimi API", .en: "Kimi API", .ja: "Kimi API",
            .fr: "Kimi API", .ru: "Kimi API",
        ],
        "custom.preset.openrouter-key.field.data_limit": [
            .zh: "额度上限", .zhHant: "額度上限", .en: "Limit", .ja: "上限",
            .fr: "Plafond", .ru: "Лимит",
        ],
        "custom.preset.openrouter-key.field.data_limit_remaining": [
            .zh: "剩余额度", .zhHant: "剩餘額度", .en: "Remaining", .ja: "Restant",
            .fr: "Remaining", .ru: "Remaining",
        ],
        "custom.preset.openrouter-key.field.data_usage": [
            .zh: "已用额度", .zhHant: "已用額度", .en: "Usage", .ja: "使用量",
            .fr: "Usage", .ru: "Расход",
        ],
        "custom.preset.poe.field.current_point_balance": [
            .zh: "积分余额", .zhHant: "點數餘額", .en: "Point balance", .ja: "ポイント残高",
            .fr: "Solde de points", .ru: "Баланс баллов",
        ],
        "custom.role.count": [
            .zh: "计数", .zhHant: "計數", .en: "Count", .ja: "回数",
            .fr: "Compteur", .ru: "Счётчик",
        ],
        "custom.role.count.default": [
            .zh: "次数", .zhHant: "次數", .en: "Count", .ja: "回数",
            .fr: "Nombre", .ru: "Число",
        ],
        "custom.role.limit": [
            .zh: "总额", .zhHant: "總額", .en: "Limit", .ja: "上限",
            .fr: "Plafond", .ru: "Лимит",
        ],
        "custom.role.other": [
            .zh: "数值", .zhHant: "數值", .en: "Value", .ja: "数値",
            .fr: "Valeur", .ru: "Значение",
        ],
        "custom.role.percent": [
            .zh: "百分比", .zhHant: "百分比", .en: "Percent", .ja: "割合",
            .fr: "Pourcentage", .ru: "Процент",
        ],
        "custom.role.percent.default": [
            .zh: "百分比", .zhHant: "百分比", .en: "Percent", .ja: "パーセント",
            .fr: "Pourcentage", .ru: "Процент",
        ],
        "custom.role.remaining": [
            .zh: "余额", .zhHant: "餘額", .en: "Balance", .ja: "残高",
            .fr: "Solde", .ru: "Остаток",
        ],
        "custom.role.timestamp": [
            .zh: "时间", .zhHant: "時間", .en: "Time", .ja: "時刻",
            .fr: "Date", .ru: "Время",
        ],
        "custom.role.timestamp.default": [
            .zh: "到期时间", .zhHant: "到期時間", .en: "Expires", .ja: "期限",
            .fr: "Expiration", .ru: "Срок",
        ],
        "custom.role.used": [
            .zh: "已用", .zhHant: "已用", .en: "Used", .ja: "使用済み",
            .fr: "Utilisé", .ru: "Использовано",
        ],
        "custom.template.addAccount": [
            .zh: "从模板添加账号", .zhHant: "從範本新增帳號", .en: "Add account from template", .ja: "テンプレートから追加",
            .fr: "Ajouter depuis le modèle", .ru: "Добавить из шаблона",
        ],
        "custom.template.delete": [
            .zh: "删除模板", .zhHant: "刪除範本", .en: "Delete template", .ja: "テンプレートを削除",
            .fr: "Supprimer le modèle", .ru: "Удалить шаблон",
        ],
        "custom.template.inUse": [
            .zh: "仍有账号使用此模板，无法删除。", .zhHant: "仍有帳號使用此範本，無法刪除。", .en: "Accounts still use this template, so it can't be deleted.", .ja: "このテンプレートを使うアカウントがあるため削除できません。",
        ...
        "custom.template.section": [
            .zh: "自定义模板", .zhHant: "自訂範本", .en: "Custom templates", .ja: "カスタム テンプレート",
            .fr: "Modèles perso", .ru: "Свои шаблоны",
        ],
        "custom.token.footer": [
            .zh: "令牌只存在本机独立键，不进快照、不上传。", .zhHant: "權杖只存在本機獨立鍵，不進快照、不上傳。", .en: "The token stays in a separate on-device key. It is not stored in snapshots and is never uploaded.", .ja: "トークンは端末内の別キーにのみ保存され、スナップショットにもアップロードされません。",
        ...
        "custom.token.placeholder": [
            .zh: "Bearer 令牌", .zhHant: "Bearer 權杖", .en: "Bearer token", .ja: "Bearer トークン",
            .fr: "Jeton Bearer", .ru: "Bearer-токен",
        ],
        "custom.token.save": [
            .zh: "保存令牌", .zhHant: "儲存權杖", .en: "Save token", .ja: "トークンを保存",
        ...
        "custom.wizard.addAccount": [
            .zh: "添加账号", .zhHant: "新增帳號", .en: "Add account", .ja: "アカウントを追加",
            .fr: "Ajouter un compte", .ru: "Добавить аккаунт",
        ],
        "custom.wizard.autoPicked": [
            .zh: "已按字段名自动勾选 %d 项，可自行增减", .zhHant: "已依欄位名自動勾選 %d 項，可自行增減", .en: "%d fields auto-selected by name; adjust as needed", .ja: "フィールド名から %d 件を自動選択しました",
        ...
        "custom.wizard.chooseIcon": [
            .zh: "选择图标", .zhHant: "選擇圖示", .en: "Choose icon", .ja: "アイコンを選択",
            .fr: "Choisir une icône", .ru: "Выбрать значок",
        ],
        "custom.wizard.clearIcon": [
            .zh: "清除图标", .zhHant: "清除圖示", .en: "Clear icon", .ja: "アイコンを消去",
            .fr: "Effacer l'icône", .ru: "Убрать значок",
        ],
        "custom.wizard.displayName": [
            .zh: "展示名", .zhHant: "顯示名", .en: "Label", .ja: "表示名",
            .fr: "Libellé", .ru: "Подпись",
        ],
        "custom.wizard.editTemplate": [
            .zh: "编辑模板", .zhHant: "編輯範本", .en: "Edit template", .ja: "テンプレートを編集",
            .fr: "Modifier le modèle", .ru: "Изменить шаблон",
        ],
        "custom.wizard.httpsOnly": [
            .zh: "只接受 https 地址。", .zhHant: "只接受 https 網址。", .en: "HTTPS URLs only.", .ja: "https のみ。",
            .fr: "URL HTTPS uniquement.", .ru: "Только HTTPS.",
        ],
        "custom.wizard.name": [
            .zh: "显示名称", .zhHant: "顯示名稱", .en: "Display name", .ja: "表示名",
            .fr: "Nom affiché", .ru: "Отображаемое имя",
        ],
        "custom.wizard.needField": [
            .zh: "请至少勾选一项要展示的字段。", .zhHant: "請至少勾選一項要顯示的欄位。", .en: "Select at least one field to display.", .ja: "表示するフィールドを 1 つ以上選んでください。",
            .fr: "Sélectionnez au moins un champ à afficher.", .ru: "Выберите хотя бы одно поле для отображения.",
        ],
        "custom.wizard.pickHint": [
            .zh: "勾选要展示的数字字段，至少一项。", .zhHant: "勾選要顯示的數字欄位，至少一項。", .en: "Pick at least one numeric field to show.", .ja: "表示する数値フィールドを 1 つ以上選んでください。",
            .fr: "Cochez au moins un champ numérique à afficher.", .ru: "Выберите хотя бы одно числовое поле.",
        ],
        "custom.wizard.presetHint": [
            .zh: "网址和字段已按此预设填好。保存前仍须通过一次实时测试。", .zhHant: "網址與欄位已依此預設填好。儲存前仍須通過一次即時測試。", .en: "URL and fields are prefilled from this preset. You still must pass a live test before saving.", .ja: "URL とフィールドはこのプリセットで入力済み。保存前に実地テストが必要です。",
        ...
        "custom.wizard.recommended": [
            .zh: "推荐", .zhHant: "推薦", .en: "Suggested", .ja: "おすすめ",
            .fr: "Suggéré", .ru: "Рекомендовано",
        ],
        "custom.wizard.replaceIcon": [
            .zh: "替换图标", .zhHant: "更換圖示", .en: "Replace icon", .ja: "アイコンを差し替え",
            .fr: "Remplacer l'icône", .ru: "Заменить значок",
        ],
        "custom.wizard.retestRequired": [
            .zh: "改模板须重新测试成功后才能保存。", .zhHant: "改範本須重新測試成功後才能儲存。", .en: "Re-test successfully before saving template changes.", .ja: "テンプレート変更は再テスト成功後に保存できます。",
            .fr: "Retestez avec succès avant d'enregistrer le modèle.", .ru: "Перед сохранением шаблона нужна успешная повторная проверка.",
        ],
        "custom.wizard.role": [
            .zh: "字段类型", .zhHant: "欄位類型", .en: "Field type", .ja: "フィールド種別",
            .fr: "Type de champ", .ru: "Тип поля",
        ],
        "custom.wizard.rootGroup": [
            .zh: "顶层", .zhHant: "頂層", .en: "Top level", .ja: "トップレベル",
            .fr: "Racine", .ru: "Корень",
        ],
        "custom.wizard.save": [
            .zh: "保存并添加账号", .zhHant: "儲存並新增帳號", .en: "Save and add account", .ja: "保存してアカウントを追加",
            .fr: "Enregistrer et ajouter", .ru: "Сохранить и добавить",
        ],
        "custom.wizard.saveHint": [
            .zh: "先勾选至少一项要展示的字段。", .zhHant: "先勾選至少一項要顯示的欄位。", .en: "Check at least one field to display.", .ja: "表示するフィールドを 1 つ以上選んでください。",
            .fr: "Cochez au moins un champ à afficher.", .ru: "Отметьте хотя бы одно поле для отображения.",
        ],
        "custom.wizard.saveTemplate": [
            .zh: "保存模板", .zhHant: "儲存範本", .en: "Save template", .ja: "テンプレートを保存",
            .fr: "Enregistrer le modèle", .ru: "Сохранить шаблон",
        ],
        "custom.wizard.status": [
            .zh: "HTTP %d · %d 字节", .zhHant: "HTTP %d · %d 位元組", .en: "HTTP %d · %d bytes", .ja: "HTTP %d · %d バイト",
            .fr: "HTTP %d · %d octets", .ru: "HTTP %d · %d байт",
        ],
        "custom.wizard.test": [
            .zh: "测试连接", .zhHant: "測試連線", .en: "Test connection", .ja: "接続をテスト",
            .fr: "Tester la connexion", .ru: "Проверить соединение",
        ],
        "custom.wizard.testing": [
            .zh: "正在请求…", .zhHant: "正在請求…", .en: "Requesting…", .ja: "リクエスト中…",
            .fr: "Requête en cours…", .ru: "Запрос…",
        ],
        "custom.wizard.title": [
            .zh: "配置自定义用量", .zhHant: "設定自訂用量", .en: "Set up custom usage", .ja: "カスタム使用量を設定",
            .fr: "Configurer l'usage perso", .ru: "Настройка своего usage",
        ],
        "custom.wizard.token": [
            .zh: "访问令牌", .zhHant: "存取權杖", .en: "Access token", .ja: "アクセス トークン",
            .fr: "Jeton d'accès", .ru: "Токен доступа",
        ],
        "custom.wizard.truncated": [
            .zh: "字段过多，已截断显示。", .zhHant: "欄位過多，已截斷顯示。", .en: "Too many fields; list truncated.", .ja: "フィールドが多すぎるため一部のみ表示。",
            .fr: "Trop de champs ; liste tronquée.", .ru: "Слишком много полей; список обрезан.",
        ],
        "custom.wizard.url": [
            .zh: "用量接口 URL", .zhHant: "用量 API 網址", .en: "Usage API URL", .ja: "使用量 API の URL",
        ...
        "deepseek.balance": [
            .zh: "重置余额", .zhHant: "重置餘額", .en: "Prepaid balance", .ja: "チャージ残高",
            .fr: "Solde prépayé", .ru: "Предоплата",
        ],
        "deepseek.balanceGranted": [
            .zh: "赠送余额", .zhHant: "贈送餘額", .en: "Granted balance", .ja: "付与残高",
            .fr: "Solde offert", .ru: "Подаренный баланс",
        ],
        "deepseek.balancePaid": [
            .zh: "充值余额", .zhHant: "儲值餘額", .en: "Paid balance", .ja: "チャージ残高",
            .fr: "Solde payant", .ru: "Оплаченный баланс",
        ],
        "deepseek.byKey": [
            .zh: "按 API Key", .zhHant: "依 API Key", .en: "By API Key", .ja: "API キー別",
            .fr: "Par clé API", .ru: "По API-ключу",
        ],
        "deepseek.cost": [
            .zh: "消费金额", .zhHant: "消費金額", .en: "Cost", .ja: "金額",
            .fr: "Coût", .ru: "Расход",
        ],
        "deepseek.expandHint": [
            .zh: "展开查看时间维度与 API Key", .zhHant: "展開查看時間維度與 API Key", .en: "Expand for time range and API keys", .ja: "展開して期間と API キーを表示",
            .fr: "Développer pour périodes et clés API", .ru: "Развернуть период и API-ключи",
        ],
        "deepseek.reqCount": [
            .zh: "%d 次", .zhHant: "%d 次", .en: "%d req", .ja: "%d 回",
            .fr: "%d req", .ru: "%d запр.",
        ],
        "deepseek.requests": [
            .zh: "API 请求次数", .zhHant: "API 請求次數", .en: "API requests", .ja: "API リクエスト",
            .fr: "Requêtes API", .ru: "Запросы API",
        ],
        "deepseek.spent": [
            .zh: "累计消费金额", .zhHant: "累計消費金額", .en: "Total spent", .ja: "累計消費",
            .fr: "Dépensé au total", .ru: "Всего потрачено",
        ],
        "deepseek.tokens": [
            .zh: "Tokens", .zhHant: "Tokens", .en: "Tokens", .ja: "トークン",
            .fr: "Jetons", .ru: "Токены",
        ],
        "demo.banner": [
        ...
        "diagnostics.copied": [
            .zh: "已复制", .zhHant: "已拷貝", .en: "Copied", .ja: "コピーしました",
            .fr: "Copié", .ru: "Скопировано",
        ],
        "diagnostics.copy": [
            .zh: "复制", .zhHant: "拷貝", .en: "Copy", .ja: "コピー",
            .fr: "Copier", .ru: "Копировать",
        ],
        "diagnostics.empty": [
            .zh: "暂无诊断记录", .zhHant: "暫無診斷記錄", .en: "No diagnostic records", .ja: "診断記録はありません",
            .fr: "Aucun journal de diagnostic", .ru: "Нет записей диагностики",
        ],
        "diagnostics.emptyHint": [
            .zh: "刷新后，每个探针的状态、脱敏预览和解析摘要会出现在这里。", .zhHant: "重新整理後，每個探針的狀態、去識別化預覽和解析摘要會出現在這裡。", .en: "After a refresh, each probe's status, redacted preview, and parse summary show up here.", .ja: "更新後、各プローブの状態・伏せ字プレビュー・解析要約がここに出ます。",
        ...
        "diagnostics.shareSubject": [
            .zh: "Usage Limits 诊断", .zhHant: "Usage Limits 診斷", .en: "Usage Limits diagnostics", .ja: "Usage Limits 診断",
            .fr: "Diagnostics Usage Limits", .ru: "Диагностика Usage Limits",
        ],
        "disabled.all.hint": [
            .zh: "到右上角设置 → 服务商 → 新增供应商，添加需要关注的账号。", .zhHant: "到右上角設定 → 服務商 → 新增供應商，加入需要關注的帳號。", .en: "Go to Settings → Providers → Add provider (top right) to add accounts.", .ja: "右上の設定 → プロバイダ → プロバイダを追加からアカウントを追加してください。",
        ...
        "disabled.all.title": [
            .zh: "还没有添加供应商", .zhHant: "尚未新增供應商", .en: "No providers added yet", .ja: "プロバイダが未追加です",
            .fr: "Aucun fournisseur ajouté", .ru: "Провайдеры ещё не добавлены",
        ],
        "feedback.cancel": [
            .zh: "取消", .zhHant: "取消", .en: "Cancel", .ja: "キャンセル",
            .fr: "Annuler", .ru: "Отмена",
        ],
        "feedback.logs.disclosure": [
            .zh: "日志会脱敏，但可能包含账号或模板名称及用量信息。", .zhHant: "記錄會去識別化，但可能包含帳號或範本名稱及用量資訊。", .en: "Logs are redacted, but may include account or template names and usage details.", .ja: "ログは伏せ字処理されますが、アカウント名・テンプレート名・使用量情報が含まれる場合があります。",
        ...
        "feedback.logs.exclude": [
            .zh: "不携带日志", .zhHant: "不附上記錄", .en: "Without logs", .ja: "ログなし",
            .fr: "Sans journaux", .ru: "Без журнала",
        ],
        "feedback.logs.include": [
            .zh: "携带日志", .zhHant: "附上記錄", .en: "Include logs", .ja: "ログを添付",
            .fr: "Joindre les journaux", .ru: "Прикрепить журнал",
        ],
        "feedback.logs.prompt": [
            .zh: "是否携带诊断日志？", .zhHant: "是否附上診斷記錄？", .en: "Include diagnostic logs?", .ja: "診断ログを添付しますか？",
            .fr: "Joindre les journaux de diagnostic ?", .ru: "Прикрепить журнал диагностики?",
        ],
        "feedback.mail.failed.message": [
            .zh: "邮件编辑器发生错误，请稍后重试。", .zhHant: "郵件編輯器發生錯誤，請稍後重試。", .en: "The mail composer encountered an error. Try again later.", .ja: "メール作成中にエラーが発生しました。後でもう一度お試しください。",
        ...
        "feedback.mail.failed.title": [
            .zh: "邮件编辑失败", .zhHant: "郵件編輯失敗", .en: "Couldn't prepare email", .ja: "メールを準備できませんでした",
            .fr: "Impossible de préparer l’e-mail", .ru: "Не удалось подготовить письмо",
        ],
        "feedback.mail.unavailable.message": [
            .zh: "请先在系统“邮件”App 中配置邮箱账号，然后再试。", .zhHant: "請先在系統「郵件」App 中設定電子郵件帳號，然後再試。", .en: "Set up an email account in Apple Mail, then try again.", .ja: "Appleの「メール」でアカウントを設定してから、もう一度お試しください。",
        ...
        "feedback.mail.unavailable.title": [
            .zh: "无法发送邮件", .zhHant: "無法傳送郵件", .en: "Mail unavailable", .ja: "メールを送信できません",
            .fr: "E-mail indisponible", .ru: "Почта недоступна",
        ],
        "feedback.mail.subject": [
            .zh: "Usage Limits 反馈：[请填一句概述]", .zhHant: "Usage Limits 意見回饋：[請填一句概述]",
        ...
        "jimeng.creditsUnavailableHint": [
            .zh: "系统繁忙，下拉重试", .zhHant: "系統忙碌，下拉重試", .en: "System busy. Pull to retry.", .ja: "混み合っています。引き下げて再試行",
            .fr: "Système occupé. Tirez pour réessayer.", .ru: "Система занята. Потяните, чтобы повторить.",
        ],
        "jimeng.expandHint": [
            .zh: "展开查看近1个月明细", .zhHant: "展開查看近1個月明細", .en: "Expand for last-month ledger", .ja: "展開して1か月明細を表示",
            .fr: "Développer pour le détail du mois", .ru: "Развернуть журнал за месяц",
        ],
        "jimeng.historyCaption": [
            .zh: "仅展示近1个月，更新可能有延迟", .zhHant: "僅顯示近1個月，更新可能有延遲", .en: "Last 30 days only; updates may lag", .ja: "直近1か月のみ。反映に遅れが出ることがあります",
        ...
        "login.check": [
            .zh: "检测登录", .zhHant: "偵測登入", .en: "Check login", .ja: "ログイン確認",
            .fr: "Vérifier", .ru: "Проверить",
        ],
        "login.checking": [
            .zh: "正在检测登录状态…", .zhHant: "正在偵測登入狀態…", .en: "Checking login status…", .ja: "ログイン状態を確認中…",
            .fr: "Vérification de la connexion…", .ru: "Проверяем состояние входа…",
        ],
        "login.close": [
            .zh: "关闭", .zhHant: "關閉", .en: "Close", .ja: "閉じる",
            .fr: "Fermer", .ru: "Закрыть",
        ],
        "login.confirm.no": [
            .zh: "否", .zhHant: "否", .en: "No", .ja: "いいえ",
            .fr: "Non", .ru: "Нет",
        ],
        "login.confirm.yes": [
            .zh: "是", .zhHant: "是", .en: "Yes", .ja: "はい",
            .fr: "Oui", .ru: "Да",
        ],
        "login.confirmUse": [
            .zh: "是否登录", .zhHant: "是否登入", .en: "Use this session?", .ja: "このログインを使いますか",
            .fr: "Utiliser cette session ?", .ru: "Войти с этим аккаунтом?",
        ],
        "login.detected": [
            .zh: "已检测到登录，正在获取用量…", .zhHant: "已偵測到登入，正在取得用量…", .en: "Signed in — fetching usage…", .ja: "ログインを検出、使用状況を取得中…",
            .fr: "Connecté — récupération en cours…", .ru: "Вход обнаружен — получаем данные…",
        ],
        "login.signedInAccount": [
            .zh: "登录账号：%@", .zhHant: "登入帳號：%@", .en: "Signed-in account: %@", .ja: "ログインアカウント：%@",
            .fr: "Compte connecté : %@", .ru: "Аккаунт входа: %@",
        ],
        "metric.expirePrefix": [
            .zh: "到期：", .zhHant: "到期：", .en: "Expires: ", .ja: "期限：",
            .fr: "Expire : ", .ru: "Истекает: ",
        ],
        "metric.remaining": [
            .zh: "剩 %d/%d", .zhHant: "剩 %d/%d", .en: "%d/%d left", .ja: "残り %d/%d",
            .fr: "%d/%d restants", .ru: "Осталось %d/%d",
        ],
        "metric.resetPrefix": [
            .zh: "重置：", .zhHant: "重置：", .en: "Resets: ", .ja: "リセット：",
            .fr: "Réinit. : ", .ru: "Сброс: ",
        ],
        "metric.valid": [
            .zh: "有效", .zhHant: "有效", .en: "Active", .ja: "有効",
            .fr: "Actif", .ru: "Активна",
        ],
        "metric.weeklyService": [
            .zh: "%@（周）", .zhHant: "%@（週）", .en: "%@ (week)", .ja: "%@（週）",
            .fr: "%@ (sem.)", .ru: "%@ (нед.)",
        ],
        "metricOrder.footer": [
            .zh: "长按拖动调整顺序。折叠卡片与 2×2 显示第 1 条，桌面 2×4/4×4 显示前 2 条；首页长按额度也可打开此编辑。接口新增的计量排在最后。", .zhHant: "長按拖移調整順序。收合卡片與 2×2 顯示第 1 條，主畫面 2×4/4×4 顯示前 2 條；首頁長按額度也可打開此編輯。API 新增的計量排在最後。", .en: "Press and drag to reorder. Collapsed cards and the 2×2 widget show the first quota; 2×4/4×4 show the first two. Long-press a quota on the home screen to open this editor. Newly added quotas go last.", .ja: "長押ししてドラッグで並び替え。折りたたみカードと 2×2 は1番目、2×4/4×4 は先頭2件。ホーム画面で利用枠を長押ししても開けます。新しい利用枠は末尾に追加されます。",
        ...
        "metricOrder.reset": [
            .zh: "恢复默认顺序", .zhHant: "恢復預設順序", .en: "Reset to default", .ja: "デフォルトに戻す",
            .fr: "Rétablir l'ordre par défaut", .ru: "Сбросить порядок",
        ],
        "metricOrder.title": [
            .zh: "额度顺序", .zhHant: "額度順序", .en: "Quota order", .ja: "利用枠の順序",
            .fr: "Ordre des quotas", .ru: "Порядок квот",
        ],
        "notify.expiry.body": [
            .zh: "%@ 将于 %d 天后到期/续费", .zhHant: "%@ 將於 %d 天後到期/續訂", .en: "%@ expires/renews in %d days", .ja: "%@ は %d 日後に期限/更新となります",
            .fr: "%@ expire/se renouvelle dans %d jours", .ru: "%@ истекает/продлевается через %d дн",
        ],
        "notify.expiry.days": [
            .zh: "提前 %d 天", .zhHant: "提前 %d 天", .en: "%d days before", .ja: "%d 日前",
            .fr: "%d jours avant", .ru: "за %d дн",
        ],
        "notify.expiry.footer": [
            .zh: "仅对能获取到期/续费时间的服务商生效。", .zhHant: "僅對能取得到期/續訂時間的服務商生效。", .en: "Only applies to providers that expose an expiry/renewal date.", .ja: "期限/更新日を取得できるプロバイダのみ対象です。",
        ...
        "notify.expiry.header": [
            .zh: "套餐到期", .zhHant: "方案到期", .en: "Plan expiry", .ja: "プラン期限",
            .fr: "Expiration du forfait", .ru: "Окончание тарифа",
        ],
        "notify.expiry.title": [
            .zh: "%@ 套餐即将到期", .zhHant: "%@ 方案即將到期", .en: "%@ plan expiring soon", .ja: "%@ プランがまもなく期限",
            .fr: "Forfait %@ bientôt expiré", .ru: "%@: тариф скоро закончится",
        ],
        "notify.expiry.toggle": [
            .zh: "套餐到期提醒", .zhHant: "方案到期提醒", .en: "Plan expiry reminder", .ja: "プラン期限リマインダー",
            .fr: "Rappel d'expiration du forfait", .ru: "Напоминание об окончании тарифа",
        ],
        "notify.general.footer": [
            .zh: "提醒为本机通知，需允许通知权限；iPhone 锁屏时会自动转发到已配对的 Apple Watch。阈值与回满检测依赖 App 刷新拿到新数据（前台自动刷新或系统安排的后台刷新）。", .zhHant: "提醒為本機通知，需允許通知權限；iPhone 鎖定時會自動轉發到已配對的 Apple Watch。門檻與回滿偵測依賴 App 重新整理取得新資料（前景自動重新整理或系統安排的背景重新整理）。", .en: "Alerts are local notifications and need permission; when iPhone is locked they forward to a paired Apple Watch automatically. Threshold and reset detection rely on refreshes (foreground auto-refresh or system-scheduled background refresh).", .ja: "通知はローカル通知で、許可が必要です。iPhone ロック中はペアリング済み Apple Watch に自動転送されます。しきい値と回復検出は更新（フォアグラウンド自動更新またはシステムのバックグラウンド更新）に依存します。",
        ...
        "notify.prepaid.header": [
            .zh: "预充值金额", .zhHant: "預儲值金額", .en: "Prepaid balance", .ja: "チャージ残高",
            .fr: "Solde prépayé", .ru: "Предоплата",
        ],
        "notify.prepaid.title": [
            .zh: "%@ 余额告警", .zhHant: "%@ 餘額警示", .en: "%@ balance alert", .ja: "%@ 残高アラート",
            .fr: "Alerte de solde %@", .ru: "%@: баланс",
        ],
        "notify.prepaid.toggle": [
            .zh: "预充值金额告警", .zhHant: "預儲值金額警示", .en: "Prepaid balance alert", .ja: "チャージ残高アラート",
            .fr: "Alerte de solde prépayé", .ru: "Оповещение о предоплате",
        ],
        "notify.provider": [
            .zh: "服务商", .zhHant: "服務商", .en: "Provider", .ja: "プロバイダ",
            .fr: "Fournisseur", .ru: "Провайдер",
        ],
        "notify.reset.body.detected": [
            .zh: "%@ 可用额度已回满 100%%", .zhHant: "%@ 可用額度已回滿 100%%", .en: "%@ is back to 100%% available", .ja: "%@ の残量が 100%% に回復しました",
            .fr: "%@ est revenu à 100 %% disponible", .ru: "%@ снова доступно на 100%%",
        ],
        "notify.reset.body.scheduled": [
            .zh: "%@ 已到重置时间，可用额度应已回满", .zhHant: "%@ 已到重置時間，可用額度應已回滿", .en: "%@ reached its reset time — quota should be full again", .ja: "%@ はリセット時刻になりました。残量は回復しているはずです",
            .fr: "%@ a atteint son heure de réinitialisation — quota rechargé", .ru: "%@ достигло времени сброса — квота должна восстановиться",
        ],
        "notify.reset.footer": [
            .zh: "已知重置时间到点提醒；刷新时发现额度提前回满（供应商主动重置）也会提醒。", .zhHant: "已知重置時間到點提醒；重新整理時發現額度提前回滿（供應商主動重置）也會提醒。", .en: "Fires at the known reset time; also when a refresh finds the quota back to full early (provider-initiated reset).", .ja: "既知のリセット時刻に通知。更新時に早期回復（プロバイダ側リセット）を検出した場合も通知します。",
        ...
        "notify.reset.header": [
            .zh: "额度重置", .zhHant: "額度重置", .en: "Quota reset", .ja: "上限リセット",
            .fr: "Réinitialisation du quota", .ru: "Сброс квоты",
        ],
        "notify.reset.title": [
            .zh: "%@ 额度已重置", .zhHant: "%@ 額度已重置", .en: "%@ quota reset", .ja: "%@ 上限リセット",
            .fr: "Quota %@ réinitialisé", .ru: "%@: квота сброшена",
        ],
        "notify.reset.toggle": [
            .zh: "额度重置提醒", .zhHant: "額度重置提醒", .en: "Quota reset alert", .ja: "上限リセット通知",
            .fr: "Alerte de réinitialisation du quota", .ru: "Оповещение о сбросе квоты",
        ],
        "notify.scope.perProvider": [
            .zh: "按供应商", .zhHant: "依供應商", .en: "Per provider", .ja: "プロバイダ別",
            .fr: "Par fournisseur", .ru: "По провайдеру",
        ],
        "notify.scope.unified": [
            .zh: "统一配置", .zhHant: "統一設定", .en: "Same for all", .ja: "一括設定",
            .fr: "Commun", .ru: "Общие",
        ],
        "notify.threshold.body": [
            .zh: "%@ 已用 %d%%（阈值 %d%%）", .zhHant: "%@ 已用 %d%%（門檻 %d%%）", .en: "%@ is at %d%% (threshold %d%%)", .ja: "%@ は %d%% 使用（しきい値 %d%%）",
            .fr: "%@ est à %d %% (seuil %d %%)", .ru: "%@ — %d%% (порог %d%%)",
        ],
        "notify.threshold.footer": [
            .zh: "任一限额窗口的已用百分比达到阈值时提醒；每个窗口周期只提醒一次。", .zhHant: "任一限額時段的已用百分比達到門檻時提醒；每個時段週期只提醒一次。", .en: "Alerts when any limit window reaches the threshold; once per window cycle.", .ja: "いずれかの上限ウィンドウがしきい値に達したら通知します（各サイクル 1 回）。",
        ...
        "notify.threshold.header": [
            .zh: "额度阈值", .zhHant: "額度門檻", .en: "Usage threshold", .ja: "使用量しきい値",
            .fr: "Seuil d'usage", .ru: "Порог расхода",
        ],
        "notify.threshold.percent": [
            .zh: "触发阈值", .zhHant: "觸發門檻", .en: "Threshold", .ja: "しきい値",
            .fr: "Seuil", .ru: "Порог",
        ],
        "notify.threshold.title": [
            .zh: "%@ 额度提醒", .zhHant: "%@ 額度提醒", .en: "%@ usage alert", .ja: "%@ 使用量通知",
            .fr: "Alerte d'usage %@", .ru: "%@: расход лимита",
        ],
        "notify.threshold.toggle": [
            .zh: "额度阈值提醒", .zhHant: "額度門檻提醒", .en: "Usage threshold alert", .ja: "使用量しきい値通知",
            .fr: "Alerte de seuil d'usage", .ru: "Оповещение о пороге",
        ],
        "prepaid_credits": [
            .zh: "prepaid_credits", .zhHant: "prepaid_credits", .en: "prepaid_credits", .ja: "prepaid_credits",
            .fr: "prepaid_credits", .ru: "prepaid_credits",
        ],
        "preview.large44": [
            .zh: "4×4 总览（systemLarge）", .zhHant: "4×4 總覽（systemLarge）", .en: "4×4 overview (systemLarge)", .ja: "4×4 概要（systemLarge）",
            .fr: "4×4 vue d'ensemble (systemLarge)", .ru: "4×4 обзор (systemLarge)",
        ],
        "preview.simulated": [
            .zh: "尚未添加供应商，以下为 Claude / ChatGPT / Grok 的模拟预览；添加供应商后将显示真实数据。", .zhHant: "尚未新增供應商，以下為 Claude / ChatGPT / Grok 的模擬預覽；新增供應商後將顯示真實資料。", .en: "No providers added yet — this is a simulated preview of Claude / ChatGPT / Grok. Real data appears once you add a provider.", .ja: "プロバイダ未追加のため Claude / ChatGPT / Grok のシミュレーション表示です。追加すると実データになります。",
        ...
        "preview.noData": [
            .zh: "尚无数据：先登录任一服务商，或在设置中开启演示模式。", .zhHant: "尚無資料：先登入任一服務商，或在設定中開啟示範模式。", .en: "No data yet — sign in to a provider or turn on demo mode in Settings.", .ja: "データがありません。いずれかにログインするか、設定でデモモードをオンにしてください。",
        ...
        "preview.pickProviders": [
            .zh: "显示的账号", .zhHant: "顯示的帳號", .en: "Accounts to show", .ja: "表示するアカウント",
            .fr: "Comptes affichés", .ru: "Аккаунты",
        ],
        "preview.single24": [
            .zh: "2×4", .zhHant: "2×4", .en: "2×4", .ja: "2×4",
            .fr: "2×4", .ru: "2×4",
        ],
        "preview.small22": [
            .zh: "2×2（系统小）", .zhHant: "2×2（系統小）", .en: "2×2 (systemSmall)", .ja: "2×2（systemSmall）",
            .fr: "2×2 (systemSmall)", .ru: "2×2 (systemSmall)",
        ],
        "privacy.footer": [
            .zh: "登录凭据仅保存在本机系统 WebKit 存储中，App 只向各官方站点发起请求，不上传任何数据。自定义 token 本机另键、不上传。", .zhHant: "登入憑證僅儲存在本機系統 WebKit 儲存空間中，App 只向各官方網站發出請求，不上傳任何資料。自訂 token 本機另存、不上傳。", .en: "Credentials stay in this device's WebKit storage. The app only talks to official sites and uploads nothing. Custom tokens stay in a separate on-device key and are never uploaded.", .ja: "ログイン資格情報は本体の WebKit ストレージにのみ保存されます。アプリは公式サイトにのみアクセスし、データを一切アップロードしません。カスタム token は端末内の別キーにのみ保存し、アップロードしません。",
        ...
        "provider.name.jimeng": [
            .zh: "即梦", .zhHant: "即夢", .en: "Jimeng", .ja: "即夢",
            .fr: "Jimeng", .ru: "Jimeng",
        ],
        "provider.name.minimax_global": [
            .zh: "MiniMax 国际", .zhHant: "MiniMax 國際", .en: "MiniMax International", .ja: "MiniMax International",
            .fr: "MiniMax International", .ru: "MiniMax International",
        ],
        "provider.name.zhipu": [
            .zh: "智谱", .zhHant: "智譜", .en: "Zhipu", .ja: "智譜",
            .fr: "Zhipu", .ru: "Zhipu",
        ],
        "provider.vendor.jimeng": [
            .zh: "剪映 / 字节", .zhHant: "剪映 / 字節", .en: "CapCut / ByteDance", .ja: "CapCut / ByteDance",
            .fr: "CapCut / ByteDance", .ru: "CapCut / ByteDance",
        ],
        "provider.vendor.longcat": [
            .zh: "美团", .zhHant: "美團", .en: "Meituan", .ja: "美団",
            .fr: "Meituan", .ru: "Meituan",
        ],
        "provider.vendor.mimo": [
            .zh: "小米", .zhHant: "小米", .en: "Xiaomi", .ja: "Xiaomi",
            .fr: "Xiaomi", .ru: "Xiaomi",
        ],
        "provider.vendor.opencode": [
            .zh: "OpenCode", .zhHant: "OpenCode", .en: "OpenCode", .ja: "OpenCode",
            .fr: "OpenCode", .ru: "OpenCode",
        ],
        "provider.vendor.qoder": [
            .zh: "阿里 Qoder", .zhHant: "阿里 Qoder", .en: "Alibaba Qoder", .ja: "アリババ Qoder",
            .fr: "Alibaba Qoder", .ru: "Alibaba Qoder",
        ],
        "provider.vendor.stepfun": [
            .zh: "阶跃星辰", .zhHant: "階躍星辰", .en: "StepFun", .ja: "StepFun",
        ...
        "providers.accounts": [
            .zh: "已添加账号", .zhHant: "已新增帳號", .en: "Added accounts", .ja: "追加済みアカウント",
            .fr: "Comptes ajoutés", .ru: "Добавленные аккаунты",
        ],
        "providers.add": [
            .zh: "新增供应商", .zhHant: "新增供應商", .en: "Add provider", .ja: "プロバイダを追加",
            .fr: "Ajouter un fournisseur", .ru: "Добавить провайдера",
        ],
        "providers.addAndLogin": [
            .zh: "添加并登录", .zhHant: "新增並登入", .en: "Add & log in", .ja: "追加してログイン",
            .fr: "Ajouter et se connecter", .ru: "Добавить и войти",
        ],
        "providers.choose": [
            .zh: "选择供应商", .zhHant: "選擇供應商", .en: "Choose a provider", .ja: "プロバイダを選択",
            .fr: "Choisir un fournisseur", .ru: "Выберите провайдера",
        ],
        "providers.choose.tintHint": [
            .zh: "点右侧色环，可改该供应商的默认颜色。", .zhHant: "點右側色環，可改該供應商的預設顏色。", .en: "Tap the color ring to change that provider's default color.", .ja: "右のカラーリングをタップすると、そのプロバイダの既定カラーを変更できます。",
        ...
        "providers.custom": [
            .zh: "自定义", .zhHant: "自訂", .en: "Custom", .ja: "カスタム",
            .fr: "Personnalisé", .ru: "Свой",
        ],
        "providers.custom.footer": [
            .zh: "用 HTTPS GET + Bearer 对接自己的用量接口。", .zhHant: "用 HTTPS GET + Bearer 串接自己的用量 API。", .en: "Connect your own usage API with HTTPS GET + Bearer.", .ja: "HTTPS GET + Bearer で独自の使用量 API に接続します。",
            .fr: "Branchez votre API d'usage en HTTPS GET + Bearer.", .ru: "Подключите свой usage API через HTTPS GET + Bearer.",
        ],
        "providers.clearName": [
            .zh: "清除名称", .zhHant: "清除名稱", .en: "Clear name", .ja: "名前を消去",
            .fr: "Effacer le nom", .ru: "Очистить имя",
        ],
        "providers.customName": [
            .zh: "自定义名称", .zhHant: "自訂名稱", .en: "Custom name", .ja: "カスタム名",
            .fr: "Nom personnalisé", .ru: "Своё название",
        ],
        "providers.empty": [
            .zh: "还没有添加账号，点击下方「新增供应商」开始。", .zhHant: "尚未新增帳號，點下方「新增供應商」開始。", .en: "No accounts yet. Tap \"Add provider\" below to start.", .ja: "アカウントがまだありません。下の「プロバイダを追加」から始めてください。",
        ...
        "providers.preset.experimental": [
            .zh: "实验性", .zhHant: "實驗性", .en: "Experimental", .ja: "実験的",
            .fr: "Expérimental", .ru: "Экспериментально",
        ],
        "providers.reorder": [
            .zh: "排序", .zhHant: "排序", .en: "Reorder", .ja: "並び替え",
            .fr: "Réorganiser", .ru: "Сортировка",
        ],
        "providers.reorderDone": [
            .zh: "完成", .zhHant: "完成", .en: "Done", .ja: "完了",
            .fr: "OK", .ru: "Готово",
        ],
        "providers.resetTints": [
            .zh: "重置所有自定义颜色", .zhHant: "重置所有自訂顏色", .en: "Reset all custom colors", .ja: "カスタムカラーを全てリセット",
            .fr: "Réinitialiser toutes les couleurs", .ru: "Сбросить все свои цвета",
        ],
        "providers.resetTints.confirm": [
            .zh: "将清除所有账号与供应商的自定义颜色，恢复内置品牌色。", .zhHant: "將清除所有帳號與供應商的自訂顏色，恢復內建品牌色。", .en: "Removes all custom colors for accounts and providers, restoring built-in brand colors.", .ja: "全アカウントとプロバイダのカスタムカラーを消去し、内蔵ブランドカラーに戻します。",
        ...
        "providers.startSetup": [
            .zh: "开始配置", .zhHant: "開始設定", .en: "Start setup", .ja: "設定を開始",
            .fr: "Commencer", .ru: "Настроить",
        ],
        "settings.addWidget.footer": [
            .zh: "在桌面长按空白处 → 左上角「+」→ 搜索「Usage Limits」即可添加小组件。", .zhHant: "在主畫面長按空白處 → 左上角「+」→ 搜尋「Usage Limits」即可加入小工具。", .en: "To add a widget: long-press the Home Screen → “+” → search “Usage Limits”.", .ja: "ホーム画面を長押し → 左上の「+」→「Usage Limits」を検索してウィジェットを追加。",
        ...
        "settings.autoRefresh": [
            .zh: "自动刷新", .zhHant: "自動重新整理", .en: "Auto refresh", .ja: "自動更新",
            .fr: "Actualisation auto", .ru: "Автообновление",
        ],
        "settings.autoRefresh.footer": [
            .zh: "仅在 App 打开期间刷新，最长 60 分钟。", .zhHant: "僅在 App 開啟期間重新整理，最長 60 分鐘。", .en: "Refreshes only while the app is open, up to 60 minutes.", .ja: "アプリ起動中のみ更新。最長 60 分。",
        ...
        "settings.autoRefresh.off": [
            .zh: "不自动刷新", .zhHant: "不自動重新整理", .en: "Off", .ja: "オフ",
            .fr: "Désactivée", .ru: "Выключено",
        ],
        "settings.autoRefresh.unit": [
            .zh: "分钟", .zhHant: "分鐘", .en: "min", .ja: "分",
            .fr: "min", .ru: "мин",
        ],
        "settings.autoRefresh.unitSeconds": [
            .zh: "秒", .zhHant: "秒", .en: "sec", .ja: "秒",
            .fr: "s", .ru: "с",
        ],
        "settings.demo": [
            .zh: "演示模式", .zhHant: "示範模式", .en: "Demo mode", .ja: "デモモード",
        ...
        "settings.privacy.title": [
            .zh: "凭据全部本地化", .zhHant: "憑證全部留在本機", .en: "All credentials stay local", .ja: "資格情報はすべてローカル保存",
            .fr: "Identifiants 100 % locaux", .ru: "Все данные хранятся локально",
        ],
        "settings.providers": [
            .zh: "服务商", .zhHant: "服務商", .en: "Providers", .ja: "プロバイダ",
            .fr: "Fournisseurs", .ru: "Провайдеры",
        ],
        "settings.resetTime": [
            .zh: "重置时间", .zhHant: "重置時間", .en: "Reset time", .ja: "リセット時刻",
            .fr: "Heure de réinitialisation", .ru: "Время сброса",
        ],
        "settings.resetTime.absolute": [
            .zh: "时刻", .zhHant: "時刻", .en: "Clock time", .ja: "時刻",
            .fr: "Heure exacte", .ru: "Точное время",
        ],
        "settings.resetTime.countdown": [
            .zh: "倒计时", .zhHant: "倒數計時", .en: "Countdown", .ja: "カウントダウン",
            .fr: "Compte à rebours", .ru: "Обратный отсчёт",
        ],
        "settings.resetTime.footer": [
            .zh: "倒计时显示还剩多久；时刻显示具体钟点。", .zhHant: "倒數計時顯示還剩多久；時刻顯示具體鐘點。", .en: "Countdown shows time left; clock time shows the exact hour.", .ja: "カウントダウンは残り時間、時刻は具体的な時間です。",
        ...
        "settings.share.hideBrand": [
            .zh: "隐藏分享二维码", .zhHant: "隱藏分享 QR Code", .en: "Hide share QR code", .ja: "共有 QR を隠す",
            .fr: "Masquer le QR de partage", .ru: "Скрыть QR для шаринга",
        ],
        "settings.theme": [
            .zh: "主题", .zhHant: "主題", .en: "Theme", .ja: "テーマ",
            .fr: "Thème", .ru: "Тема",
        ],
        "settings.dashboardTheme": [
            .zh: "首页主题", .zhHant: "首頁主題", .en: "Dashboard theme", .ja: "ホームのテーマ",
            .fr: "Thème de l'accueil", .ru: "Тема главного экрана",
        ],
        "settings.dashboardTheme.flat": [
            .zh: "平铺", .zhHant: "平鋪", .en: "Flat", .ja: "フラット",
            .fr: "Plat", .ru: "Плоская",
        ],
        "settings.dashboardTheme.roulette": [
            .zh: "轮盘", .zhHant: "輪盤", .en: "Roulette", .ja: "ルーレット",
            .fr: "Roulette", .ru: "Рулетка",
        ],
        "settings.dashboardTheme.helix": [
            .zh: "螺旋", .zhHant: "螺旋", .en: "Helix", .ja: "らせん",
            .fr: "Hélice", .ru: "Спираль",
        ],
        "sideKey.label": [
            .zh: "侧边键", .zhHant: "側邊鍵", .en: "Side key", .ja: "サイドキー",
            .fr: "Touche latérale", .ru: "Боковая кнопка",
        ],
        "settings.sideKey.guideTitle": [
            .zh: "设置操作按钮", .zhHant: "設定動作按鈕", .en: "Set up the Action Button", .ja: "アクションボタンを設定",
        ...
        "settings.sideKey.guideSteps": [
            .zh: "1. 点下方「前往设置」打开 iPhone 设置，在首页点「操作按钮」\n\n2. 左右滑动，选到「快捷指令」\n\n3. 点「选择快捷指令」，在 Usage Limits 下选「侧边菜单」\n\n4. 回到本 App 首页按一下操作按钮：弹出 设置 / 分享 / 主题；再按轮换选中，点菜单项确认", .zhHant: "1. 點下方「前往設定」打開 iPhone 設定，在首頁點「動作按鈕」\n\n2. 左右滑動，選到「捷徑」\n\n3. 點「選擇捷徑」，在 Usage Limits 下選「侧边菜单」\n\n4. 回到本 App 首頁按一下動作按鈕：彈出 設定 / 分享 / 主題；再按輪換選中，點選單項目確認",
        ...
        "settings.sideKey.open": [
            .zh: "前往设置", .zhHant: "前往設定", .en: "Open Settings", .ja: "設定を開く",
            .fr: "Ouvrir Réglages", .ru: "Открыть Настройки",
        ],
        "sideKey.hint": [
            .zh: "按操作按钮打开菜单，再按轮换选中，点菜单项确认", .zhHant: "按動作按鈕打開選單，再按輪換選中，點選單項目確認",
        ...
        "sideKey.menu.share": [
            .zh: "分享", .zhHant: "分享", .en: "Share", .ja: "共有",
        ...
        "sideKey.menu.rootHint": [
            .zh: "再按操作按钮轮换选中，点菜单项确认", .zhHant: "再按動作按鈕輪換選中，點選單項目確認",
        ...
        "sideKey.menu.themeHint": [
            .zh: "再按操作按钮轮换主题，点主题切换", .zhHant: "再按動作按鈕輪換主題，點主題切換",
        ...
        "settings.dashboardTheme.footer": [
            .zh: "轮盘、螺旋是 3D 卡片场景，折叠态露出两条计量条；深浅色都跟随上面的主题设置。", .zhHant: "輪盤、螺旋是 3D 卡片場景，收合時露出兩條計量條；深淺色都跟隨上面的主題設定。",
        ...
        "settings.theme.dark": [
            .zh: "深色", .zhHant: "深色", .en: "Dark", .ja: "ダーク",
            .fr: "Sombre", .ru: "Тёмная",
        ],
        "settings.theme.light": [
            .zh: "浅色", .zhHant: "淺色", .en: "Light", .ja: "ライト",
            .fr: "Clair", .ru: "Светлая",
        ],
        ...
        "settings.version": [
            .zh: "版本", .zhHant: "版本", .en: "Version", .ja: "バージョン",
            .fr: "Version", .ru: "Версия",
        ],
        "settings.widgetPreview": [
            .zh: "小组件", .zhHant: "小工具", .en: "Widgets", .ja: "ウィジェット",
            .fr: "Widgets", .ru: "Виджеты",
        ],
        "widgets.preview": [
            .zh: "预览", .zhHant: "預覽", .en: "Preview", .ja: "プレビュー",
            .fr: "Aperçu", .ru: "Предпросмотр",
        ],
        "settings.appearance": [
            .zh: "外观", .zhHant: "外觀", .en: "Appearance", .ja: "外観",
            .fr: "Apparence", .ru: "Внешний вид",
        ],
        "settings.refreshGroup": [
            .zh: "刷新与提醒", .zhHant: "重新整理與提醒", .en: "Refresh & alerts", .ja: "更新と通知",
            .fr: "Actualisation et alertes", .ru: "Обновление и уведомления",
        ],
        "settings.advanced": [
            .zh: "高级", .zhHant: "進階", .en: "Advanced", .ja: "詳細",
            .fr: "Avancé", .ru: "Дополнительно",
        ],
        "settings.appIcon": [
            .zh: "图标", .zhHant: "圖示", .en: "App icon", .ja: "アイコン",
            .fr: "Icône", .ru: "Значок",
        ],
        "appIcon.original": [
            .zh: "原始", .zhHant: "原始", .en: "Original", .ja: "オリジナル",
            .fr: "Originale", .ru: "Оригинал",
        ],
        "appIcon.footer": [
            .zh: "更换后桌面图标随之变化；更多图标后续添加。", .zhHant: "更換後主畫面圖示隨之變化；更多圖示後續新增。", .en: "The home-screen icon changes right away; more icons are coming.", .ja: "ホーム画面のアイコンがすぐに切り替わります。今後さらに追加予定。",
        ...
        "share.moments.title": [
            .zh: "分享到朋友圈", .zhHant: "分享到朋友圈", .en: "Share to Moments", .ja: "モーメンツに共有",
            .fr: "Partager sur Moments", .ru: "Поделиться в «Моментах»",
        ],
        "share.openWeChat": [
            .zh: "打开微信", .zhHant: "打開微信", .en: "Open WeChat", .ja: "WeChat を開く",
            .fr: "Ouvrir WeChat", .ru: "Открыть WeChat",
        ],
        "share.opt.glow": [
            .zh: "光晕", .zhHant: "光暈", .en: "Glow", .ja: "グロー",
            .fr: "Halo", .ru: "Сияние",
        ],
        "share.opt.details": [
        ...
        "share.opt.hideUnused": [
            .zh: "隐藏未用", .zhHant: "隱藏未用", .en: "Hide unused", .ja: "未使用を隠す",
            .fr: "Sans inutilisé", .ru: "Скрыть пустые",
        ],
        "share.opt.sameColor": [
            .zh: "同色条", .zhHant: "同色條", .en: "Same color", .ja: "同色バー",
            .fr: "Même couleur", .ru: "Один цвет",
        ],
        "share.preview.title": [
            .zh: "分享预览", .zhHant: "分享預覽", .en: "Share preview", .ja: "共有プレビュー",
            .fr: "Aperçu du partage", .ru: "Предпросмотр",
        ],
        "share.saved": [
            .zh: "已保存到相册", .zhHant: "已儲存到照片", .en: "Saved to Photos", .ja: "写真に保存しました",
            .fr: "Enregistré dans Photos", .ru: "Сохранено в Фото",
        ],
        "share.scanAppStore": [
            .zh: "扫码下载 Usage Limits", .zhHant: "掃碼下載 Usage Limits", .en: "Scan to get Usage Limits", .ja: "スキャンして Usage Limits",
            .fr: "Scanner Usage Limits", .ru: "Сканируйте Usage Limits",
        ],
        "share.target.edit": [
            .zh: "编辑", .zhHant: "編輯", .en: "Edit", .ja: "編集",
            .fr: "Modifier", .ru: "Изменить",
        ],
        "share.target.moments": [
            .zh: "朋友圈", .zhHant: "朋友圈", .en: "Moments", .ja: "モーメント",
        ...
        "share.target.save": [
            .zh: "保存到相册", .zhHant: "儲存到照片", .en: "Save to Photos", .ja: "写真に保存",
            .fr: "Enregistrer", .ru: "В Фото",
        ],
        "share.target.wechat": [
            .zh: "微信", .zhHant: "微信", .en: "WeChat", .ja: "WeChat",
            .fr: "WeChat", .ru: "WeChat",
        ],
        "share.wechat.missing": [
            .zh: "未安装微信", .zhHant: "未安裝微信", .en: "WeChat is not installed", .ja: "WeChat がありません",
            .fr: "WeChat n'est pas installé", .ru: "WeChat не установлен",
        ],
        "time.compactMin": [
            .zh: "%d 分后", .zhHant: "%d 分後", .en: "in %dm", .ja: "%d 分後",
            .fr: "dans %d min", .ru: "через %d мин",
        ],
        "time.day": [
            .zh: "%d 天后", .zhHant: "%d 天後", .en: "in %dd", .ja: "%d 日後",
            .fr: "dans %d j", .ru: "через %d дн",
        ],
        "time.dayHour": [
            .zh: "%d 天 %d 小时后", .zhHant: "%d 天 %d 小時後", .en: "in %dd %dh", .ja: "%d 日 %d 時間後",
            .fr: "dans %d j %d h", .ru: "через %d дн %d ч",
        ],
        "time.hour": [
            .zh: "%d 小时后", .zhHant: "%d 小時後", .en: "in %dh", .ja: "%d 時間後",
            .fr: "dans %d h", .ru: "через %d ч",
        ],
        "time.hourMin": [
            .zh: "%d 小时 %d 分后", .zhHant: "%d 小時 %d 分後", .en: "in %dh %dm", .ja: "%d 時間 %d 分後",
            .fr: "dans %d h %d min", .ru: "через %d ч %d мин",
        ],
        "time.min": [
            .zh: "%d 分钟后", .zhHant: "%d 分鐘後", .en: "in %dm", .ja: "%d 分後",
            .fr: "dans %d min", .ru: "через %d мин",
        ],
        "time.reset": [
            .zh: "已重置", .zhHant: "已重置", .en: "Reset", .ja: "リセット済み",
            .fr: "Réinitialisé", .ru: "Сброшено",
        ],
        "time.tomorrowAt": [
            .zh: "明天 %@", .zhHant: "明天 %@", .en: "tomorrow %@", .ja: "明日 %@",
            .fr: "demain %@", .ru: "завтра %@",
        ],
        "tint.color": [
            .zh: "颜色", .zhHant: "顏色", .en: "Color", .ja: "カラー",
            .fr: "Couleur", .ru: "Цвет",
        ],
        "tint.end": [
            .zh: "结束色", .zhHant: "結束色", .en: "End color", .ja: "終了色",
            .fr: "Couleur de fin", .ru: "Конечный цвет",
        ],
        "tint.gradient": [
            .zh: "渐变", .zhHant: "漸層", .en: "Gradient", .ja: "グラデーション",
            .fr: "Dégradé", .ru: "Градиент",
        ],
        "tint.hex": [
            .zh: "色号", .zhHant: "色碼", .en: "Hex", .ja: "カラーコード",
            .fr: "Code hex", .ru: "Hex-код",
        ],
        "tint.menu": [
            .zh: "主题色…", .zhHant: "主題色…", .en: "Theme color…", .ja: "テーマカラー…",
            .fr: "Couleur du thème…", .ru: "Цвет темы…",
        ],
        "tint.mode": [
            .zh: "颜色模式", .zhHant: "顏色模式", .en: "Color mode", .ja: "カラーモード",
            .fr: "Mode de couleur", .ru: "Режим цвета",
        ],
        "tint.picker": [
            .zh: "取色器", .zhHant: "取色器", .en: "Color picker", .ja: "カラーピッカー",
        ...
        "tint.providerDefault": [
            .zh: "默认颜色", .zhHant: "預設顏色", .en: "Default color", .ja: "既定カラー",
            .fr: "Couleur par défaut", .ru: "Цвет по умолчанию",
        ],
        "tint.restoreDefault": [
            .zh: "恢复默认", .zhHant: "恢復預設", .en: "Restore default", .ja: "デフォルトに戻す",
            .fr: "Rétablir par défaut", .ru: "Сбросить по умолчанию",
        ],
        "tint.restoreDefault.footer": [
            .zh: "清除本层自定义：账号回落供应商默认色，供应商回落内置品牌色。", .zhHant: "清除本層自訂：帳號回落供應商預設色，供應商回落內建品牌色。", .en: "Clears this override: accounts fall back to the provider default, providers fall back to the built-in brand color.", .ja: "この設定を消去：アカウントはプロバイダ既定色に、プロバイダは内蔵ブランドカラーに戻ります。",
        ...
        "tint.solid": [
            .zh: "纯色", .zhHant: "純色", .en: "Solid", .ja: "単色",
            .fr: "Uni", .ru: "Однотонный",
        ],
        "tint.start": [
            .zh: "起始色", .zhHant: "起始色", .en: "Start color", .ja: "開始色",
            .fr: "Couleur de départ", .ru: "Начальный цвет",
        ],
        "watch.enableHint": [
            .zh: "向上滑动，在设置中开启", .zhHant: "向上滑動，在設定中開啟", .en: "Swipe up to enable in Settings", .ja: "上にスワイプして設定でオン",
            .fr: "Balayez vers le haut pour activer dans Réglages", .ru: "Смахните вверх и включите в настройках",
        ],
        "watch.loginOnPhone": [
            .zh: "在 iPhone 上登录后自动同步", .zhHant: "在 iPhone 上登入後自動同步", .en: "Sign in on iPhone to sync", .ja: "iPhone でログインすると同期されます",
            .fr: "Connectez-vous sur l'iPhone pour synchroniser", .ru: "Войдите на iPhone — данные синхронизируются",
        ],
        "watch.syncFooter": [
            .zh: "开关与 iPhone App 实时同步。", .zhHant: "開關與 iPhone App 即時同步。", .en: "Toggles sync with the iPhone app.", .ja: "スイッチは iPhone アプリと同期します。",
            .fr: "Les réglages se synchronisent avec l'app iPhone.", .ru: "Переключатели синхронизируются с приложением на iPhone.",
        ],
        "widget.accountType": [
            .zh: "账号", .zhHant: "帳號", .en: "Account", .ja: "アカウント",
            .fr: "Compte", .ru: "Аккаунт",
        ],
        "widget.metricType": [
            .zh: "额度", .zhHant: "額度", .en: "Quotas", .ja: "利用枠",
            .fr: "Quotas", .ru: "Квоты",
        ],
        "widget.quotaParam": [
            .zh: "额度（留空则跟随首页）", .zhHant: "額度（留空則跟隨首頁）", .en: "Quotas (empty = follow home)", .ja: "利用枠（空欄ならホームに従う）",
            .fr: "Quotas (vide = suivre l'accueil)", .ru: "Квоты (пусто = как на главном экране)",
        ],
        "widget.allDisabled": [
            .zh: "所有服务商都已停用", .zhHant: "所有服務商都已停用", .en: "All providers disabled", .ja: "すべてのプロバイダが無効",
            .fr: "Tous les fournisseurs désactivés", .ru: "Все провайдеры отключены",
        ],
        "widget.chooseAccount": [
            .zh: "选择账号", .zhHant: "選擇帳號", .en: "Choose account", .ja: "アカウントを選択",
            .fr: "Choisir un compte", .ru: "Выбрать аккаунт",
        ],
        "widget.disabled": [
            .zh: "已停用", .zhHant: "已停用", .en: "Disabled", .ja: "無効",
            .fr: "Désactivé", .ru: "Отключено",
        ],
        "widget.enableInApp": [
            .zh: "在 App 设置中重新开启", .zhHant: "在 App 設定中重新開啟", .en: "Re-enable in app Settings", .ja: "アプリの設定でオンにしてください",
            .fr: "Réactivez dans les réglages", .ru: "Включите в настройках приложения",
        ],
        "widget.gallery.medium": [
            .zh: "中等总览", .zhHant: "中型總覽", .en: "Medium overview", .ja: "中サイズ概要",
            .fr: "Aperçu moyen", .ru: "Средний обзор",
        ],
        "widget.gallery.mediumDetail": [
            .zh: "几行进度条总览。", .zhHant: "幾行進度條總覽。", .en: "A few quota bars.", .ja: "数行の進捗バー。",
            .fr: "Quelques barres de quota.", .ru: "Несколько полос квот.",
        ],
        "widget.gallery.large": [
            .zh: "多账号总览", .zhHant: "多帳號總覽", .en: "Multi-account overview", .ja: "複数アカウント概要",
            .fr: "Aperçu multi-comptes", .ru: "Обзор нескольких аккаунтов",
        ],
        "widget.gallery.largeDetail": [
            .zh: "按账号实例分组；额度取各实例首页排序的前几条。", .zhHant: "依帳號實例分組；額度取各實例首頁排序的前幾條。", .en: "Grouped by account; each shows its first homepage quotas.", .ja: "アカウントごとにまとめ、ホーム順の先頭クォータを表示。",
            .fr: "Groupé par compte ; premiers quotas de l'accueil.", .ru: "По аккаунтам: первые квоты с главного экрана.",
        ],
        "widget.gallery.single": [
            .zh: "单服务商", .zhHant: "單一服務商", .en: "Single provider", .ja: "単一プロバイダ",
            .fr: "Un fournisseur", .ru: "Один провайдер",
        ],
        "widget.gallery.singleDetail": [
            .zh: "圆环显示该账号的当前用量。", .zhHant: "圓環顯示該帳號的目前用量。", .en: "A ring for this account's current usage.", .ja: "このアカウントの使用量をリング表示。",
            .fr: "Un anneau pour l'usage de ce compte.", .ru: "Кольцо текущего расхода аккаунта.",
        ],
        "widget.highestUsage": [
            .zh: "最高用量（自动）", .zhHant: "最高用量（自動）", .en: "Highest usage (auto)", .ja: "使用量がいちばん高い（自動）",
            .fr: "Plus forte utilisation (auto)", .ru: "Наибольший расход (авто)",
        ],
        "widget.homeSlot": [
            .zh: "首页额度 %d", .zhHant: "首頁額度 %d", .en: "Home quota %d", .ja: "ホーム利用枠 %d",
            .fr: "Quota d'accueil %d", .ru: "Квота %d с главного экрана",
        ],
        "widget.emptySlot": [
            .zh: "（空）", .zhHant: "（空）", .en: "(empty)", .ja: "（空き）",
            .fr: "(vide)", .ru: "(пусто)",
        ],
        "widget.followHome": [
            .zh: "跟随首页额度", .zhHant: "跟隨首頁額度", .en: "Follow home quotas", .ja: "ホームの利用枠に従う",
            .fr: "Suivre les quotas d'accueil", .ru: "Как на главном экране",
        ],
        "widget.more": [
            .zh: "还有 %d 项，打开 App 查看", .zhHant: "還有 %d 項，打開 App 查看", .en: "%d more — open the app", .ja: "他 %d 件はアプリで表示",
            .fr: "%d de plus — ouvrez l'app", .ru: "Ещё %d — смотрите в приложении",
        ],
        "widget.noNumeric": [
            .zh: "已登录，官方未提供数值额度", .zhHant: "已登入，官方未提供數值額度", .en: "Signed in — no numeric limits", .ja: "ログイン済み・数値上限なし",
            .fr: "Connecté — pas de limites chiffrées", .ru: "Вход выполнен — нет числовых лимитов",
        ],
        "widget.openToLogin": [
            .zh: "打开 App 登录", .zhHant: "打開 App 登入", .en: "Open the app to sign in", .ja: "アプリでログイン",
            .fr: "Ouvrez l'app pour vous connecter", .ru: "Откройте приложение для входа",
        ],
        "widget.overviewDescription": [
            .zh: "勾选账号实例；额度自动取首页排序的前几条。", .zhHant: "勾選帳號實例；額度自動取首頁排序的前幾條。", .en: "Pick accounts; quotas follow homepage order.", .ja: "アカウントを選び、クォータはホーム順。",
        ...
        "widget.overviewTitle": [
            .zh: "用量总览", .zhHant: "用量總覽", .en: "Usage overview", .ja: "使用量の概要",
        ...
        "widget.singleDescription": [
            .zh: "单个服务商的用量。", .zhHant: "單一服務商的用量。", .en: "Usage for one provider.", .ja: "1つのプロバイダの使用量。",
            .fr: "Usage d'un fournisseur.", .ru: "Расход одного провайдера.",
        ],
        "上月": [
            .zh: "上月", .zhHant: "上月", .en: "Last month", .ja: "先月",
            .fr: "Le mois dernier", .ru: "Прошлый месяц",
        ],
        "上限": [
            .zh: "上限", .zhHant: "上限", .en: "Limit", .ja: "上限",
            .fr: "Plafond", .ru: "Лимит",
        ],
        "专家": [
            .zh: "专家", .zhHant: "專家", .en: "Expert", .ja: "エキスパート",
            .fr: "Expert", .ru: "Эксперт",
        ],
        "今天": [
            .zh: "今天", .zhHant: "今天", .en: "Today", .ja: "今日",
            .fr: "Aujourd'hui", .ru: "Сегодня",
        ],
        "今日": [
            .zh: "今日", .zhHant: "今日", .en: "Today", .ja: "今日",
            .fr: "Aujourd'hui", .ru: "Сегодня",
        ],
        "今日 tokens": [
            .zh: "今日 tokens", .zhHant: "今日 tokens", .en: "Tokens today", .ja: "本日のトークン",
            .fr: "Tokens du jour", .ru: "Токены сегодня",
        ],
        "今日限额": [
            .zh: "今日限额", .zhHant: "今日限額", .en: "Daily limit", .ja: "本日の上限",
            .fr: "Limite quotidienne", .ru: "Лимит за день",
        ],
        "付费": [
            .zh: "付费", .zhHant: "付費", .en: "Paid", .ja: "有料",
            .fr: "Payé", .ru: "Платно",
        ],
        "低谷 0.5x": [
            .zh: "低谷 0.5x", .zhHant: "離峰 0.5x", .en: "Off-peak 0.5x", .ja: "オフピーク 0.5x",
        ...
        "余额数据异常": [
            .zh: "余额数据异常", .zhHant: "餘額資料異常", .en: "Balance data is invalid", .ja: "残高データが不正です",
            .fr: "Solde invalide", .ru: "Данные баланса неверны",
        ],
        "充值积分": [
            .zh: "充值积分", .zhHant: "儲值點數", .en: "Purchased credits", .ja: "チャージクレジット",
            .fr: "Crédits achetés", .ru: "Купленные кредиты",
        ],
        "分类 %d": [
            .zh: "分类 %d", .zhHant: "分類 %d", .en: "Category %d", .ja: "分類 %d",
            .fr: "Catégorie %d", .ru: "Категория %d",
        ],
        "分钟": [
            .zh: "分钟", .zhHant: "分鐘", .en: "minutes", .ja: "分",
            .fr: "minutes", .ru: "мин",
        ],
        "剩余": [
            .zh: "剩余", .zhHant: "剩餘", .en: "Left", .ja: "残り",
            .fr: "Restant", .ru: "Осталось",
        ],
        "剩余积分": [
            .zh: "剩余积分", .zhHant: "剩餘點數", .en: "Remaining credits", .ja: "残りクレジット",
            .fr: "Crédits restants", .ru: "Оставшиеся кредиты",
        ],
        "剩余额度": [
            .zh: "剩余额度", .zhHant: "剩餘額度", .en: "Remaining quota", .ja: "残り枠",
        ...
        "加油包": [
            .zh: "加油包", .zhHant: "加油包", .en: "Fuel pack", .ja: "追加パック",
            .fr: "Pack bonus", .ru: "Пакет пополнения",
        ],
        "周窗口": [
            .zh: "周窗口", .zhHant: "每週時段", .en: "Weekly window", .ja: "週間ウィンドウ",
            .fr: "Fenêtre hebdo", .ru: "Недельное окно",
        ],
        "周限额": [
            .zh: "周限额", .zhHant: "週限額", .en: "Weekly limit", .ja: "週間上限",
            .fr: "Limite hebdo", .ru: "Недельный лимит",
        ],
        "响应状态码异常": [
            .zh: "响应状态码异常", .zhHant: "回應狀態碼異常", .en: "Unexpected response status", .ja: "予期しないステータス",
            .fr: "Statut de réponse inattendu", .ru: "Неожиданный статус ответа",
        ],
        "图像生成": [
            .zh: "图像生成", .zhHant: "圖像生成", .en: "Image generation", .ja: "画像生成",
            .fr: "Génération d'images", .ru: "Генерация изображений",
        ],
        "图生视频": [
            .zh: "图生视频", .zhHant: "圖生影片", .en: "Image to video", .ja: "画像から動画",
            .fr: "Image vers vidéo", .ru: "Изображение в видео",
        ],
        "天": [
            .zh: "天", .zhHant: "天", .en: "days", .ja: "日",
            .fr: "j", .ru: "дн.",
        ],
        "季": [
            .zh: "季", .zhHant: "季", .en: "qtr", .ja: "四半期",
            .fr: "trim.", .ru: "кв.",
        ],
        "小时": [
            .zh: "小时", .zhHant: "小時", .en: "hours", .ja: "時間",
            .fr: "heures", .ru: "ч",
        ],
        "现金余额": [
            .zh: "现金余额", .zhHant: "現金餘額", .en: "Cash balance", .ja: "現金残高",
        ...
        "已使用": [
            .zh: "已使用", .zhHant: "已使用", .en: "Used", .ja: "使用済み",
            .fr: "Utilisé", .ru: "Использовано",
        ],
        "已用": [
            .zh: "已用", .zhHant: "已用", .en: "Used", .ja: "使用済み",
        ...
        "已用额度": [
            .zh: "已用额度", .zhHant: "已用額度", .en: "Used quota", .ja: "使用済み枠",
            .fr: "Quota utilisé", .ru: "Использованная квота",
        ],
        "年": [
            .zh: "年", .zhHant: "年", .en: "yr", .ja: "年",
            .fr: "an", .ru: "год",
        ],
        "当前 workspace 不适用 Notion AI 额度": [
            .zh: "当前 workspace 不适用 Notion AI 额度", .zhHant: "目前 workspace 不適用 Notion AI 額度", .en: "This workspace has no Notion AI quota", .ja: "このワークスペースにNotion AI枠はありません",
            .fr: "Cet espace n'a pas de quota Notion AI", .ru: "У этого workspace нет квоты Notion AI",
        ],
        "快速": [
            .zh: "快速", .zhHant: "快速", .en: "Fast", .ja: "高速",
            .fr: "Rapide", .ru: "Быстрый",
        ],
        "总用量": [
            .zh: "总用量", .zhHant: "總用量", .en: "Total usage", .ja: "合計使用量",
            .fr: "Usage total", .ru: "Общий расход",
        ],
        "按月重置": [
            .zh: "按月重置", .zhHant: "按月重置", .en: "Resets monthly", .ja: "毎月リセット",
            .fr: "Réinitialisation mensuelle", .ru: "Сброс раз в месяц",
        ],
        "控制台接口无响应": [
            .zh: "控制台接口无响应", .zhHant: "主控台 API 無回應", .en: "Console API did not respond", .ja: "コンソールAPIが応答しません",
            .fr: "L'API console n'a pas répondu", .ru: "API консоли не ответила",
        ],
        "推理": [
            .zh: "推理", .zhHant: "推理", .en: "Reasoning", .ja: "推論",
            .fr: "Raisonnement", .ru: "Рассуждение",
        ],
        "插件": [
            .zh: "插件", .zhHant: "外掛", .en: "Plugins", .ja: "プラグイン",
            .fr: "Extensions", .ru: "Плагины",
        ],
        "文本生成": [
            .zh: "文本生成", .zhHant: "文字生成", .en: "Text generation", .ja: "テキスト生成",
            .fr: "Génération de texte", .ru: "Генерация текста",
        ],
        "文生视频": [
            .zh: "文生视频", .zhHant: "文生影片", .en: "Text to video", .ja: "テキストから動画",
            .fr: "Texte vers vidéo", .ru: "Текст в видео",
        ],
        "无上限": [
            .zh: "无上限", .zhHant: "無上限", .en: "Unlimited", .ja: "無制限",
            .fr: "Illimité", .ru: "Без лимита",
        ],
        "无网络": [
            .zh: "无网络", .zhHant: "無網路", .en: "No network", .ja: "ネットワークなし",
            .fr: "Pas de réseau", .ru: "Нет сети",
        ],
        "无限制": [
            .zh: "无限制", .zhHant: "無限制", .en: "Unlimited", .ja: "無制限",
            .fr: "Illimité", .ru: "Без лимита",
        ],
        "明文被拦": [
            .zh: "明文被拦", .zhHant: "明文被攔", .en: "Cleartext blocked", .ja: "平文が拒否されました",
            .fr: "Texte en clair bloqué", .ru: "Открытый текст заблокирован",
        ],
        "昨天": [
            .zh: "昨天", .zhHant: "昨天", .en: "Yesterday", .ja: "昨日",
            .fr: "Hier", .ru: "Вчера",
        ],
        "智谱响应状态码异常": [
            .zh: "智谱响应状态码异常", .zhHant: "智譜回應狀態碼異常", .en: "Zhipu response status is invalid", .ja: "Zhipuのステータスが不正です",
            .fr: "Statut Zhipu invalide", .ru: "Некорректный статус Zhipu",
        ],
        "智谱接口失败": [
            .zh: "智谱接口失败", .zhHant: "智譜 API 失敗", .en: "Zhipu request failed", .ja: "Zhipu リクエスト失敗",
            .fr: "Échec Zhipu", .ru: "Ошибка Zhipu",
        ],
        "最近到期": [
            .zh: "最近到期", .zhHant: "最近到期", .en: "Expires", .ja: "最近の期限",
            .fr: "Expire le", .ru: "Истекает",
        ],
        "月": [
            .zh: "月", .zhHant: "月", .en: "mo", .ja: "月",
            .fr: "mois", .ru: "мес.",
        ],
        "月度额度": [
            .zh: "月度额度", .zhHant: "每月額度", .en: "Monthly quota", .ja: "月間枠",
            .fr: "Quota mensuel", .ru: "Месячная квота",
        ],
        "未找到 Notion workspace": [
            .zh: "未找到 Notion workspace", .zhHant: "找不到 Notion workspace", .en: "No Notion workspace found", .ja: "Notionワークスペースが見つかりません",
            .fr: "Aucun espace Notion trouvé", .ru: "Workspace Notion не найден",
        ],
        "未找到 T3 Chat 用量数据": [
            .zh: "未找到 T3 Chat 用量数据", .zhHant: "找不到 T3 Chat 用量資料", .en: "T3 Chat usage data not found", .ja: "T3 Chat使用量データが見つかりません",
            .fr: "Données d'usage T3 Chat introuvables", .ru: "Данные использования T3 Chat не найдены",
        ],
        "未知时长": [
            .zh: "未知时长", .zhHant: "未知時長", .en: "Unknown duration", .ja: "不明な期間",
            .fr: "Durée inconnue", .ru: "Неизвестная длительность",
        ],
        "未获取到 Notion AI 额度响应": [
            .zh: "未获取到 Notion AI 额度响应", .zhHant: "未取得 Notion AI 額度回應", .en: "Did not receive Notion AI quota response", .ja: "Notion AI枠の応答がありません",
            .fr: "Pas de réponse de quota Notion AI", .ru: "Нет ответа квоты Notion AI",
        ],
        "未获取到 Notion workspace 响应": [
            .zh: "未获取到 Notion workspace 响应", .zhHant: "未取得 Notion workspace 回應", .en: "Did not receive Notion workspace response", .ja: "Notionワークスペース応答がありません",
            .fr: "Pas de réponse d'espace Notion", .ru: "Нет ответа workspace Notion",
        ],
        "未获取到 Ollama settings 响应": [
            .zh: "未获取到 Ollama settings 响应", .zhHant: "未取得 Ollama settings 回應", .en: "Did not receive Ollama settings response", .ja: "Ollama設定応答がありません",
            .fr: "Pas de réponse des réglages Ollama", .ru: "Нет ответа настроек Ollama",
        ],
        "未获取到 StepFun 用量响应": [
            .zh: "未获取到 StepFun 用量响应", .zhHant: "未取得 StepFun 用量回應", .en: "Did not receive StepFun usage response", .ja: "StepFun使用量応答がありません",
            .fr: "Pas de réponse d'usage StepFun", .ru: "Нет ответа использования StepFun",
        ],
        "未获取到 T3 Chat 响应": [
            .zh: "未获取到 T3 Chat 响应", .zhHant: "未取得 T3 Chat 回應", .en: "Did not receive T3 Chat response", .ja: "T3 Chat応答がありません",
            .fr: "Pas de réponse T3 Chat", .ru: "Нет ответа T3 Chat",
        ],
        "未获取到任何响应": [
            .zh: "未获取到任何响应", .zhHant: "未取得任何回應", .en: "No response received", .ja: "応答がありません",
            .fr: "Aucune réponse", .ru: "Нет ответа",
        ],
        "未获取到余额响应": [
            .zh: "未获取到余额响应", .zhHant: "未取得餘額回應", .en: "Did not receive balance response", .ja: "残高応答がありません",
            .fr: "Pas de réponse de solde", .ru: "Нет ответа по балансу",
        ],
        "未获取到用量数据": [
            .zh: "未获取到用量数据", .zhHant: "未取得用量資料", .en: "Did not receive usage data", .ja: "使用量データがありません",
            .fr: "Pas de données d'usage", .ru: "Нет данных об использовании",
        ],
        "未获取到算力点响应": [
            .zh: "未获取到算力点响应", .zhHant: "未取得算力點回應", .en: "Did not receive compute-points response", .ja: "コンピュートポイント応答がありません",
            .fr: "Pas de réponse des points de calcul", .ru: "Нет ответа по баллам вычислений",
        ],
        "未获取到额度响应": [
            .zh: "未获取到额度响应", .zhHant: "未取得額度回應", .en: "Did not receive quota response", .ja: "枠の応答がありません",
            .fr: "Pas de réponse de quota", .ru: "Нет ответа квоты",
        ],
        "本周用量": [
            .zh: "本周用量", .zhHant: "本週用量", .en: "Weekly usage", .ja: "今週の使用量",
            .fr: "Usage hebdo", .ru: "Расход за неделю",
        ],
        "本周限额": [
            .zh: "本周限额", .zhHant: "本週限額", .en: "Weekly limit", .ja: "今週の上限",
            .fr: "Limite hebdomadaire", .ru: "Лимит за неделю",
        ],
        "本月": [
            .zh: "本月", .zhHant: "本月", .en: "This month", .ja: "今月",
            .fr: "Ce mois", .ru: "Этот месяц",
        ],
        "本月限额": [
            .zh: "本月限额", .zhHant: "本月限額", .en: "Monthly limit", .ja: "今月の上限",
            .fr: "Limite mensuelle", .ru: "Лимит за месяц",
        ],
        "标准": [
            .zh: "标准", .zhHant: "標準", .en: "Standard", .ja: "標準",
            .fr: "Standard", .ru: "Стандарт",
        ],
        "每周": [
            .zh: "每周", .zhHant: "每週", .en: "Weekly", .ja: "毎週",
            .fr: "Hebdomadaire", .ru: "Еженедельно",
        ],
        "每周窗口": [
            .zh: "每周窗口", .zhHant: "每週時段", .en: "Weekly window", .ja: "週間ウィンドウ",
            .fr: "Fenêtre hebdo", .ru: "Недельное окно",
        ],
        "每天": [
            .zh: "每天", .zhHant: "每天", .en: "Daily", .ja: "毎日",
            .fr: "Quotidien", .ru: "Ежедневно",
        ],
        "每 %d 小时": [
            .zh: "每 %d 小时", .zhHant: "每 %d 小時", .en: "Every %d hours", .ja: "%d時間ごと",
            .fr: "Toutes les %d h", .ru: "Каждые %d ч",
        ],
        "每 %d 分钟": [
            .zh: "每 %d 分钟", .zhHant: "每 %d 分鐘", .en: "Every %d minutes", .ja: "%d分ごと",
            .fr: "Toutes les %d min", .ru: "Каждые %d мин",
        ],
        "每 %d 天": [
            .zh: "每 %d 天", .zhHant: "每 %d 天", .en: "Every %d days", .ja: "%d日ごと",
            .fr: "Tous les %d j", .ru: "Каждые %d дн.",
        ],
        "每 %d 周": [
            .zh: "每 %d 周", .zhHant: "每 %d 週", .en: "Every %d weeks", .ja: "%d週ごと",
            .fr: "Toutes les %d sem.", .ru: "Каждые %d нед.",
        ],
        "每月窗口": [
            .zh: "每月窗口", .zhHant: "每月時段", .en: "Monthly window", .ja: "月間ウィンドウ",
            .fr: "Fenêtre mensuelle", .ru: "Месячное окно",
        ],
        "活跃天数": [
            .zh: "活跃天数", .zhHant: "活躍天數", .en: "Active days", .ja: "利用日数",
            .fr: "Jours actifs", .ru: "Активные дни",
        ],
        "游客额度": [
            .zh: "游客额度", .zhHant: "訪客額度", .en: "Guest quota", .ja: "ゲスト枠",
            .fr: "Quota invité", .ru: "Гостевая квота",
        ],
        "Grok 需要浏览器验证": [
            .zh: "Grok 要求浏览器验证，当前用量请求未通过。请先在官网完成验证后重试。", .zhHant: "Grok 要求瀏覽器驗證，目前用量請求未通過。請先在官網完成驗證後重試。",
        ...
        "请先完成官网登录并进入用量页面": [
            .zh: "请先在官网完成登录，并返回账号或用量页面后再检测。", .zhHant: "請先在官網完成登入，並返回帳號或用量頁面後再偵測。",
        ...
        "检测到游客额度，请先登录账号": [
            .zh: "当前获取到的是游客额度，尚未确认账号登录。", .zhHant: "目前取得的是訪客額度，尚未確認帳號登入。",
        ...
        "login.webOnlyBlocked": [
            .zh: "已阻止打开其他 App，请在网页中完成登录。", .zhHant: "已阻止打開其他 App，請在網頁中完成登入。",
        ...
        "login.continueOnWeb": [
            .zh: "继续网页登录", .zhHant: "繼續網頁登入", .en: "Continue on web", .ja: "Web で続ける",
            .fr: "Continuer sur le web", .ru: "Продолжить на сайте",
        ],
        "尚未检测到登录会话": [
            .zh: "官网用量接口尚未识别到登录会话，请完成登录回跳后再试。", .zhHant: "官網用量 API 尚未辨識到登入工作階段，請完成登入回跳後再試。",
        ...
        "用量数据异常": [
            .zh: "用量数据异常", .zhHant: "用量資料異常", .en: "Usage data is invalid", .ja: "使用量データが不正です",
            .fr: "Données d'usage invalides", .ru: "Данные расхода неверны",
        ],
        "短期限流": [
            .zh: "短期限流", .zhHant: "短期限流", .en: " short rate limit", .ja: "短期レート制限",
        ...
        "积分余额": [
            .zh: "积分余额", .zhHant: "點數餘額", .en: "Credit balance", .ja: "クレジット残高",
            .fr: "Solde de crédits", .ru: "Баланс кредитов",
        ],
        "窗口": [
            .zh: "窗口", .zhHant: "時段", .en: "window", .ja: "ウィンドウ",
            .fr: "fenêtre", .ru: "окно",
        ],
        "窗口 %d 分钟": [
            .zh: "窗口 %d 分钟", .zhHant: "%d 分鐘時段", .en: "%d-minute window", .ja: "%d分ウィンドウ",
            .fr: "Fenêtre %d min", .ru: "Окно %d мин",
        ],
        "窗口 %d 小时": [
            .zh: "窗口 %d 小时", .zhHant: "%d 小時時段", .en: "%d-hour window", .ja: "%d時間ウィンドウ",
            .fr: "Fenêtre %d h", .ru: "Окно %d ч",
        ],
        "第三方": [
            .zh: "第三方", .zhHant: "第三方", .en: "Third party", .ja: "サードパーティ",
            .fr: "Tiers", .ru: "Сторонние",
        ],
        "算力点数据异常": [
            .zh: "算力点数据异常", .zhHant: "算力點資料異常", .en: "Compute-points data is invalid", .ja: "コンピュートポイントデータが不正です",
            .fr: "Données de points de calcul invalides", .ru: "Некорректные баллы вычислений",
        ],
        "系统繁忙": [
            .zh: "系统繁忙", .zhHant: "系統忙碌", .en: "System busy", .ja: "システム混雑中",
            .fr: "Système occupé", .ru: "Система занята",
        ],
        "累计调用量": [
            .zh: "累计调用量", .zhHant: "累計呼叫量", .en: "Lifetime calls", .ja: "累計呼び出し",
            .fr: "Appels cumulés", .ru: "Всего вызовов",
        ],
        "网络错误": [
            .zh: "网络错误", .zhHant: "網路錯誤", .en: "Network error", .ja: "ネットワークエラー",
            .fr: "Erreur réseau", .ru: "Ошибка сети",
        ],
        "自动": [
            .zh: "自动", .zhHant: "自動", .en: "Auto", .ja: "自動",
            .fr: "Auto", .ru: "Авто",
        ],
        "视频赠送": [
            .zh: "视频赠送", .zhHant: "影片贈送", .en: "Video bonus", .ja: "動画ボーナス",
            .fr: "Bonus vidéo", .ru: "Бонус видео",
        ],
        "计费时段": [
            .zh: "计费时段", .zhHant: "計費時段", .en: "Billing window", .ja: "課金時間帯",
            .fr: "Fenêtre tarifaire", .ru: "Тарифное окно",
        ],
        "订阅积分": [
            .zh: "订阅积分", .zhHant: "訂閱點數", .en: "Subscription credits", .ja: "サブスククレジット",
            .fr: "Crédits d'abonnement", .ru: "Кредиты подписки",
        ],
        "证书不受信任": [
            .zh: "证书不受信任", .zhHant: "憑證不受信任", .en: "Untrusted certificate", .ja: "証明書が信頼できません",
            .fr: "Certificat non fiable", .ru: "Сертификат не доверен",
        ],
        "语音合成": [
            .zh: "语音合成", .zhHant: "語音合成", .en: "Speech synthesis", .ja: "音声合成",
        ...
        "请求超时": [
            .zh: "请求超时", .zhHant: "請求逾時", .en: "Request timed out", .ja: "タイムアウト",
            .fr: "Délai dépassé", .ru: "Тайм-аут",
        ],
        "购买额度": [
            .zh: "购买额度", .zhHant: "購買額度", .en: "Purchased quota", .ja: "購入枠",
            .fr: "Quota acheté", .ru: "Купленная квота",
        ],
        "赠送": [
            .zh: "赠送", .zhHant: "贈送", .en: "Bonus", .ja: "ボーナス",
            .fr: "Bonus", .ru: "Бонус",
        ],
        "赠送积分": [
            .zh: "赠送积分", .zhHant: "贈送點數", .en: "Bonus credits", .ja: "ボーナスクレジット",
            .fr: "Crédits bonus", .ru: "Бонусные кредиты",
        ],
        "赠送额度": [
            .zh: "赠送额度", .zhHant: "贈送額度", .en: "Bonus quota", .ja: "ボーナス枠",
            .fr: "Quota bonus", .ru: "Бонусная квота",
        ],
        "超时": [
            .zh: "超时", .zhHant: "逾時", .en: "Timed out", .ja: "タイムアウト",
            .fr: "Expiré", .ru: "Тайм-аут",
        ],
        "近 30 天": [
            .zh: "近 30 天", .zhHant: "近 30 天", .en: "Last 30 days", .ja: "過去30日",
            .fr: "30 derniers jours", .ru: "За 30 дней",
        ],
        "近 30 天 tokens": [
            .zh: "近 30 天 tokens", .zhHant: "近 30 天 tokens", .en: "Tokens (30 days)", .ja: "30日のトークン",
            .fr: "Tokens (30 j)", .ru: "Токены за 30 дней",
        ],
        "近 30 天消费": [
            .zh: "近 30 天消费", .zhHant: "近 30 天消費", .en: "Spend (30 days)", .ja: "30日の消費",
            .fr: "Dépense (30 j)", .ru: "Траты за 30 дней",
        ],
        "近 30 天调用量": [
            .zh: "近 30 天调用量", .zhHant: "近 30 天呼叫量", .en: "Calls (30 days)", .ja: "30日の呼び出し",
            .fr: "Appels (30 j)", .ru: "Вызовы за 30 дней",
        ],
        "近 7 天": [
            .zh: "近 7 天", .zhHant: "近 7 天", .en: "Last 7 days", .ja: "過去7日",
            .fr: "7 derniers jours", .ru: "За 7 дней",
        ],
        "近 7 天 Token": [
            .zh: "近 7 天 Token", .zhHant: "近 7 天 Token", .en: "Tokens (7 days)", .ja: "7日間のトークン",
            .fr: "Jetons (7 j)", .ru: "Токены за 7 дней",
        ],
        "近 7 天调用量": [
            .zh: "近 7 天调用量", .zhHant: "近 7 天呼叫量", .en: "Calls (7 days)", .ja: "7日の呼び出し",
            .fr: "Appels (7 j)", .ru: "Вызовы за 7 дней",
        ],
        "配额": [
            .zh: "配额", .zhHant: "配額", .en: "Quota", .ja: "クォータ",
            .fr: "Quota", .ru: "Квота",
        ],
        "配额数据异常": [
            .zh: "配额数据异常", .zhHant: "配額資料異常", .en: "Quota data is invalid", .ja: "クォータデータが不正です",
            .fr: "Données de quota invalides", .ru: "Некорректные данные квоты",
        ],
        "Gemini 未返回用量数据，请在官网确认账号与用量页": [
            .zh: "Gemini 未返回用量数据，请在官网确认账号与用量页", .zhHant: "Gemini 未回傳用量資料，請在官網確認帳號與用量頁",
        ...
        "音乐生成": [
            .zh: "音乐生成", .zhHant: "音樂生成", .en: "Music generation", .ja: "音楽生成",
            .fr: "Génération musicale", .ru: "Генерация музыки",
        ],
        "频限明细": [
            .zh: "频限明细", .zhHant: "頻限明細", .en: "Rate-limit details", .ja: "レート制限",
            .fr: "Détail du quota", .ru: "Лимит частоты",
        ],
        "账期结束": [
            .zh: "账期结束", .zhHant: "帳單週期結束", .en: "Period end", .ja: "期間終了",
            .fr: "Fin de période", .ru: "Конец периода",
        ],
        "额度上限": [
            .zh: "额度上限", .zhHant: "額度上限", .en: "Quota limit", .ja: "枠上限",
            .fr: "Plafond de quota", .ru: "Лимит квоты",
        ],
        "额度数据异常": [
            .zh: "额度数据异常", .zhHant: "額度資料異常", .en: "Quota data is invalid", .ja: "枠データが不正です",
            .fr: "Données de quota invalides", .ru: "Некорректные данные квоты",
        ],
        "限额": [
            .zh: "限额", .zhHant: "限額", .en: "Limit", .ja: "上限",
            .fr: "Limite", .ru: "Лимит",
        ],
        "附加 %d": [
            .zh: "附加 %d", .zhHant: "附加 %d", .en: "Extra %d", .ja: "追加 %d",
            .fr: "Extra %d", .ru: "Доп. %d",
        ],
        "状态": [
            .zh: "状态", .zhHant: "狀態", .en: "Status", .ja: "状態",
            .fr: "État", .ru: "Статус",
        ],
        "高峰 1x": [
            .zh: "高峰 1x", .zhHant: "尖峰 1x", .en: "Peak 1x", .ja: "ピーク 1x",
            .fr: "Heure de pointe 1x", .ru: "Пик 1x",
        ],
        "（超额）": [
            .zh: "（超额）", .zhHant: "（超額）", .en: " (overage)", .ja: "（超過）",
            .fr: " (dépassement)", .ru: " (сверх лимита)",
        ],
        "（积分）": [
            .zh: "（积分）", .zhHant: "（點數）", .en: " (credits)", .ja: "（クレジット）",
